...
|:---|---:|---:|
| Total |  1,087.82 |  140.66 |
| reth_block |  1,087.82 |  140.66 |


| reth_block |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  108,782.30 |  1,087,823 |  140,661 |  38,768 |
| `main_cells_used     ` |  1,259,276,381.80 |  12,592,763,818 |  2,224,814,786 |  289,554,583 |
| `total_cycles        ` |  20,594,173.40 |  205,941,734 |  24,805,499 |  1,959,710 |
| `execute_time_ms     ` |  7,178.40 |  71,784 |  10,277 |  493 |
| `trace_gen_time_ms   ` |  27,994.70 |  279,947 |  35,845 |  18,463 |
| `stark_prove_excluding_trace_time_ms` |  73,609.20 |  736,092 |  101,660 |  19,812 |
| `main_trace_commit_time_ms` |  11,637.30 |  116,373 |  17,956 |  5,456 |
| `generate_perm_trace_time_ms` |  1,786.60 |  17,866 |  2,524 |  364 |
| `perm_trace_commit_time_ms` |  23,551.30 |  235,513 |  31,367 |  3,767 |
| `quotient_poly_compute_time_ms` |  18,209.70 |  182,097 |  31,825 |  4,268 |
| `quotient_poly_commit_time_ms` |  5,354.60 |  53,546 |  6,148 |  1,664 |
| `pcs_opening_time_ms ` |  13,052.30 |  130,523 |  15,312 |  4,246 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| reth_block | 21000000 | 0 | 20,478 | 91,346 | 23,016,688 | 3,097,815,952 | 63,432 | 11,040 | 5,836 | 20,424 | 12,693 | 11,337 | 1,086,140,722 | 2,083 | 7,436 | 
| reth_block | 21000000 | 1 | 20,339 | 91,461 | 22,995,680 | 3,098,129,796 | 64,011 | 12,353 | 4,930 | 21,800 | 12,708 | 10,140 | 1,081,953,851 | 2,072 | 7,111 | 
| reth_block | 21000000 | 2 | 31,785 | 140,661 | 23,521,082 | 5,712,670,752 | 101,660 | 28,474 | 6,009 | 31,367 | 15,312 | 17,956 | 2,224,814,786 | 2,524 | 7,216 | 
| reth_block | 21000000 | 3 | 31,208 | 123,191 | 23,491,489 | 3,935,171,168 | 81,706 | 19,649 | 6,084 | 24,200 | 14,606 | 14,814 | 1,359,337,174 | 2,333 | 10,277 | 
| reth_block | 21000000 | 4 | 25,807 | 113,834 | 23,900,943 | 3,264,844,128 | 80,363 | 21,696 | 5,968 | 26,543 | 14,176 | 10,077 | 1,089,148,977 | 1,875 | 7,664 | 
| reth_block | 21000000 | 5 | 32,707 | 119,077 | 24,805,499 | 3,527,098,144 | 77,287 | 17,368 | 5,953 | 27,734 | 14,667 | 9,673 | 1,150,718,655 | 1,885 | 9,083 | 
| reth_block | 21000000 | 6 | 29,792 | 111,935 | 24,266,058 | 3,253,900,512 | 73,539 | 17,143 | 6,148 | 25,406 | 14,105 | 9,250 | 1,108,309,808 | 1,479 | 8,604 | 
| reth_block | 21000000 | 7 | 33,523 | 121,503 | 23,901,751 | 3,446,705,056 | 79,747 | 18,281 | 5,771 | 28,676 | 14,420 | 11,077 | 1,278,383,634 | 1,509 | 8,233 | 
| reth_block | 21000000 | 8 | 35,845 | 136,047 | 14,082,834 | 5,563,896,352 | 94,535 | 31,825 | 5,183 | 25,596 | 13,590 | 16,593 | 1,924,401,628 | 1,742 | 5,667 | 
| reth_block | 21000000 | 9 | 18,463 | 38,768 | 1,959,710 | 646,847,544 | 19,812 | 4,268 | 1,664 | 3,767 | 4,246 | 5,456 | 289,554,583 | 364 | 493 | 

</details>


Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/4d578d9971fb0268ed653ad860eb3059437c0165
...
[Benchmark Workflow](https://github.com/axiom-crypto/openvm-reth-benchmark/actions/runs/12943450982)
