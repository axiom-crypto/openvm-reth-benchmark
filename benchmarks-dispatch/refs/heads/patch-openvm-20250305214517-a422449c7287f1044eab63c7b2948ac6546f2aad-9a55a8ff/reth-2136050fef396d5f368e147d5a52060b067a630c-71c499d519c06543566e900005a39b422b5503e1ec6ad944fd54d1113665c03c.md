...
|:---|---:|---:|
| Total |  703.27 |  220.34 |
| reth.prove_e2e.block_21000000 |  370.02 |  46.83 |
| leaf |  119.48 |  12.95 |
| internal.0 |  50.37 |  9.08 |
| internal.1 |  14.08 |  4.74 |
| internal.2 |  7.24 |  4.65 |
| internal.3 |  4.69 |  4.69 |
| internal.4 |  2.61 |  2.61 |
| root |  38.20 |  38.20 |
| halo2_outer |  56.38 |  56.38 |
| halo2_wrapper |  40.21 |  40.21 |
| agg_keygen |  38.47 |  38.03 |


| reth.prove_e2e.block_21000000 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  33,638.18 |  370,020 |  46,833 |  8,656 |
| `main_cells_used     ` |  1,144,742,171.27 |  12,592,163,884 |  1,926,729,008 |  289,733,955 |
| `total_cycles        ` |  18,494,338.82 |  203,437,727 |  24,801,156 |  1,959,998 |
| `execute_time_ms     ` |  2,738.45 |  30,123 |  5,893 |  264 |
| `trace_gen_time_ms   ` |  8,719.73 |  95,917 |  10,865 |  3,299 |
| `stark_prove_excluding_trace_time_ms` |  22,180 |  243,980 |  34,962 |  5,093 |
| `main_trace_commit_time_ms` |  5,782.73 |  63,610 |  12,012 |  1,403 |
| `generate_perm_trace_time_ms` |  1,454.18 |  15,996 |  1,987 |  206 |
| `perm_trace_commit_time_ms` |  5,680.27 |  62,483 |  7,629 |  1,028 |
| `quotient_poly_compute_time_ms` |  3,643.55 |  40,079 |  6,871 |  794 |
| `quotient_poly_commit_time_ms` |  1,578.73 |  17,366 |  1,966 |  476 |
| `pcs_opening_time_ms ` |  4,029.18 |  44,321 |  4,837 |  1,177 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,862 |  119,482 |  12,951 |  8,278 |
| `main_cells_used     ` |  205,610,156.91 |  2,261,711,726 |  255,906,171 |  146,745,683 |
| `total_cycles        ` |  2,062,739.73 |  22,690,137 |  2,523,289 |  1,528,167 |
| `execute_time_ms     ` |  813.64 |  8,950 |  961 |  634 |
| `trace_gen_time_ms   ` |  1,552.91 |  17,082 |  1,912 |  1,100 |
| `stark_prove_excluding_trace_time_ms` |  8,495.45 |  93,450 |  10,128 |  6,544 |
| `main_trace_commit_time_ms` |  1,441.09 |  15,852 |  1,667 |  1,145 |
| `generate_perm_trace_time_ms` |  527 |  5,797 |  665 |  356 |
| `perm_trace_commit_time_ms` |  2,521.09 |  27,732 |  3,228 |  1,770 |
| `quotient_poly_compute_time_ms` |  1,155.82 |  12,714 |  1,439 |  828 |
| `quotient_poly_commit_time_ms` |  889.09 |  9,780 |  1,010 |  757 |
| `pcs_opening_time_ms ` |  1,957.73 |  21,535 |  2,188 |  1,680 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,394.17 |  50,365 |  9,083 |  5,076 |
| `main_cells_used     ` |  124,745,436.83 |  748,472,621 |  136,034,932 |  68,985,151 |
| `total_cycles        ` |  1,886,823.50 |  11,320,941 |  2,058,523 |  1,029,324 |
| `execute_time_ms     ` |  784.17 |  4,705 |  859 |  431 |
| `trace_gen_time_ms   ` |  893.17 |  5,359 |  1,001 |  516 |
| `stark_prove_excluding_trace_time_ms` |  6,716.83 |  40,301 |  7,242 |  4,129 |
| `main_trace_commit_time_ms` |  1,454.50 |  8,727 |  1,585 |  832 |
| `generate_perm_trace_time_ms` |  261.67 |  1,570 |  286 |  149 |
| `perm_trace_commit_time_ms` |  1,280.17 |  7,681 |  1,387 |  781 |
| `quotient_poly_compute_time_ms` |  1,146 |  6,876 |  1,240 |  696 |
| `quotient_poly_commit_time_ms` |  1,135.50 |  6,813 |  1,230 |  747 |
| `pcs_opening_time_ms ` |  1,435 |  8,610 |  1,548 |  920 |

| internal.1 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,692.67 |  14,078 |  4,739 |  4,664 |
| `main_cells_used     ` |  67,479,571.33 |  202,438,714 |  67,677,853 |  67,083,107 |
| `total_cycles        ` |  1,226,694 |  3,680,082 |  1,229,267 |  1,221,559 |
| `execute_time_ms     ` |  382.67 |  1,148 |  386 |  378 |
| `trace_gen_time_ms   ` |  522 |  1,566 |  531 |  516 |
| `stark_prove_excluding_trace_time_ms` |  3,788 |  11,364 |  3,830 |  3,764 |
| `main_trace_commit_time_ms` |  799.33 |  2,398 |  808 |  793 |
| `generate_perm_trace_time_ms` |  127.33 |  382 |  128 |  126 |
| `perm_trace_commit_time_ms` |  673.67 |  2,021 |  677 |  671 |
| `quotient_poly_compute_time_ms` |  602 |  1,806 |  611 |  597 |
| `quotient_poly_commit_time_ms` |  708 |  2,124 |  717 |  703 |
| `pcs_opening_time_ms ` |  873 |  2,619 |  885 |  865 |

| internal.2 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,619 |  7,238 |  4,647 |  2,591 |
| `main_cells_used     ` |  50,216,625 |  100,433,250 |  66,381,685 |  34,051,565 |
| `total_cycles        ` |  910,785 |  1,821,570 |  1,214,156 |  607,414 |
| `execute_time_ms     ` |  277.50 |  555 |  369 |  186 |
| `trace_gen_time_ms   ` |  395 |  790 |  518 |  272 |
| `stark_prove_excluding_trace_time_ms` |  2,946.50 |  5,893 |  3,760 |  2,133 |
| `main_trace_commit_time_ms` |  606 |  1,212 |  791 |  421 |
| `generate_perm_trace_time_ms` |  96.50 |  193 |  127 |  66 |
| `perm_trace_commit_time_ms` |  520.50 |  1,041 |  671 |  370 |
| `quotient_poly_compute_time_ms` |  461 |  922 |  598 |  324 |
| `quotient_poly_commit_time_ms` |  561 |  1,122 |  700 |  422 |
| `pcs_opening_time_ms ` |  697.50 |  1,395 |  870 |  525 |

| internal.3 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,689 |  4,689 |  4,689 |  4,689 |
| `main_cells_used     ` |  65,829,694 |  65,829,694 |  65,829,694 |  65,829,694 |
| `total_cycles        ` |  1,206,474 |  1,206,474 |  1,206,474 |  1,206,474 |
| `execute_time_ms     ` |  364 |  364 |  364 |  364 |
| `trace_gen_time_ms   ` |  501 |  501 |  501 |  501 |
| `stark_prove_excluding_trace_time_ms` |  3,824 |  3,824 |  3,824 |  3,824 |
...
| `main_cells_used     ` |  34,052,393 |  34,052,393 |  34,052,393 |  34,052,393 |
| `total_cycles        ` |  607,506 |  607,506 |  607,506 |  607,506 |
...
| `main_trace_commit_time_ms` |  423 |  423 |  423 |  423 |
| `generate_perm_trace_time_ms` |  66 |  66 |  66 |  66 |
| `perm_trace_commit_time_ms` |  371 |  371 |  371 |  371 |
| `quotient_poly_compute_time_ms` |  326 |  326 |  326 |  326 |
| `quotient_poly_commit_time_ms` |  422 |  422 |  422 |  422 |
| `pcs_opening_time_ms ` |  531 |  531 |  531 |  531 |

| root |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  38,197 |  38,197 |  38,197 |  38,197 |
| `main_cells_used     ` |  33,383,191 |  33,383,191 |  33,383,191 |  33,383,191 |
| `total_cycles        ` |  600,168 |  600,168 |  600,168 |  600,168 |
| `execute_time_ms     ` |  178 |  178 |  178 |  178 |
| `trace_gen_time_ms   ` |  260 |  260 |  260 |  260 |
| `stark_prove_excluding_trace_time_ms` |  37,759 |  37,759 |  37,759 |  37,759 |
| `main_trace_commit_time_ms` |  12,056 |  12,056 |  12,056 |  12,056 |
| `generate_perm_trace_time_ms` |  64 |  64 |  64 |  64 |
| `perm_trace_commit_time_ms` |  8,390 |  8,390 |  8,390 |  8,390 |
| `quotient_poly_compute_time_ms` |  733 |  733 |  733 |  733 |
| `quotient_poly_commit_time_ms` |  12,793 |  12,793 |  12,793 |  12,793 |
| `pcs_opening_time_ms ` |  3,718 |  3,718 |  3,718 |  3,718 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  56,383 |  56,383 |  56,383 |  56,383 |
| `main_cells_used     ` |  58,076,647 |  58,076,647 |  58,076,647 |  58,076,647 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  40,207 |  40,207 |  40,207 |  40,207 |

| agg_keygen |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  19,234 |  38,468 |  38,035 |  433 |
| `main_cells_used     ` |  41,063,749 |  82,127,498 |  81,199,429 |  928,069 |
| `total_cycles        ` |  1,357,899 |  1,357,899 |  1,357,899 |  1,357,899 |
| `execute_time_ms     ` |  88.50 |  177 |  177 |  0 |
| `trace_gen_time_ms   ` |  151.50 |  303 |  275 |  28 |
| `stark_prove_excluding_trace_time_ms` |  18,994 |  37,988 |  37,583 |  405 |
| `main_trace_commit_time_ms` |  6,018.50 |  12,037 |  11,979 |  58 |
| `generate_perm_trace_time_ms` |  35.50 |  71 |  64 |  7 |
| `perm_trace_commit_time_ms` |  4,222.50 |  8,445 |  8,388 |  57 |
| `quotient_poly_compute_time_ms` |  379.50 |  759 |  733 |  26 |
| `quotient_poly_commit_time_ms` |  6,375 |  12,750 |  12,684 |  66 |
| `pcs_opening_time_ms ` |  1,959 |  3,918 |  3,729 |  189 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 21000000 | 275 | 38,035 | 1,357,899 | 261,902,304 | 37,583 | 733 | 12,684 | 8,388 | 3,729 | 1 | 11,979 | 81,199,429 | 7,911,006 | 19,094 | 64 | 177 | 
| halo2_outer | 21000000 |  | 56,383 |  |  |  |  |  |  |  |  |  | 58,076,647 |  |  |  |  | 
| halo2_wrapper | 21000000 |  | 40,207 |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 21000000 | 0 | 953 | 9,031 | 2,058,325 | 346,276,824 | 7,227 | 1,236 | 1,212 | 1,383 | 1,532 | 1,576 | 135,920,826 | 283 | 851 | 
| internal.0 | 21000000 | 1 | 1,001 | 9,083 | 2,058,006 | 346,276,824 | 7,227 | 1,237 | 1,208 | 1,373 | 1,535 | 1,585 | 136,034,932 | 284 | 855 | 
| internal.0 | 21000000 | 2 | 964 | 9,061 | 2,058,523 | 346,276,824 | 7,242 | 1,240 | 1,210 | 1,381 | 1,548 | 1,576 | 135,805,631 | 284 | 855 | 
