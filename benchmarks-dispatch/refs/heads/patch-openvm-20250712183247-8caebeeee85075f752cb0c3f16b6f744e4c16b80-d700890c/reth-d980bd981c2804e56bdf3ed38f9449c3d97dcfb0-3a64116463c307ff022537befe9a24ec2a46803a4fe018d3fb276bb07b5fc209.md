...
| `execute_e1_time_ms  ` |  2,874 |  2,874 |  2,874 |  2,874 |
| `execute_e1_insn_mi/s` |  55.11 | -          |  55.11 |  55.11 |
| `execute_metered_time_ms` |  4,505 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  35.17 | -          |  35.17 |  35.17 |
...
| --- | --- | --- |
| 21000000 | 4,856 | 3,148 | 

| group | block_number | insns | execute_metered_time_ms | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insn_mi/s |
| --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_21000000 | 21000000 | 158,428,408 | 4,505 | 35.17 | 2,874 | 55.11 | 

</details>


Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/actions/runs/16271806333
