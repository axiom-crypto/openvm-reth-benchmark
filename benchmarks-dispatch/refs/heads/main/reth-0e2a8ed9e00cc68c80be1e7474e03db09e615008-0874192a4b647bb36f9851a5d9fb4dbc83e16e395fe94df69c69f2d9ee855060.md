...
|:---|---:|---:|
| Total |  473.89 |  186.46 |
| reth.prove_evm.block_21000000 |  240.34 |  28.69 |
| leaf |  79.83 |  9.23 |
| internal.0 |  33.32 |  8.95 |
| internal.1 |  8.34 |  5.83 |
...
| `total_proof_time_ms ` |  21,848.64 |  240,335 |  28,689 |  5,343 |
| `main_cells_used     ` |  1,091,479,503.27 |  12,006,274,536 |  1,594,147,741 |  211,058,569 |
| `total_cycles        ` |  14,281,127.18 |  157,092,399 |  22,293,932 |  1,160,721 |
| `execute_time_ms     ` |  2,302.82 |  25,331 |  3,635 |  174 |
| `trace_gen_time_ms   ` |  7,084.64 |  77,931 |  11,370 |  2,561 |
| `stark_prove_excluding_trace_time_ms` |  12,461.18 |  137,073 |  16,853 |  2,608 |
| `main_trace_commit_time_ms` |  3,331.82 |  36,650 |  6,058 |  595 |
| `generate_perm_trace_time_ms` |  816.91 |  8,986 |  1,006 |  114 |
| `perm_trace_commit_time_ms` |  2,193.27 |  24,126 |  2,591 |  309 |
| `quotient_poly_compute_time_ms` |  2,243.73 |  24,681 |  4,317 |  283 |
| `quotient_poly_commit_time_ms` |  763.18 |  8,395 |  966 |  240 |
| `pcs_opening_time_ms ` |  3,100.27 |  34,103 |  3,775 |  1,059 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,256.91 |  79,826 |  9,228 |  5,314 |
| `main_cells_used     ` |  216,261,211.36 |  2,378,873,325 |  284,864,693 |  154,560,388 |
| `total_cycles        ` |  2,743,787 |  30,181,657 |  3,518,564 |  2,022,972 |
| `execute_time_ms     ` |  889.45 |  9,784 |  1,098 |  683 |
| `trace_gen_time_ms   ` |  1,663.36 |  18,297 |  2,183 |  1,214 |
| `stark_prove_excluding_trace_time_ms` |  4,704.09 |  51,745 |  5,947 |  3,394 |
| `main_trace_commit_time_ms` |  800.73 |  8,808 |  1,000 |  524 |
| `generate_perm_trace_time_ms` |  342.09 |  3,763 |  426 |  250 |
| `perm_trace_commit_time_ms` |  1,019.36 |  11,213 |  1,318 |  711 |
| `quotient_poly_compute_time_ms` |  553.45 |  6,088 |  719 |  385 |
| `quotient_poly_commit_time_ms` |  439.36 |  4,833 |  540 |  344 |
| `pcs_opening_time_ms ` |  1,544.09 |  16,985 |  1,955 |  1,170 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,331 |  33,324 |  8,954 |  6,857 |
| `main_cells_used     ` |  193,084,021.25 |  772,336,085 |  212,773,504 |  139,491,384 |
| `total_cycles        ` |  3,227,282.25 |  12,909,129 |  3,545,694 |  2,333,242 |
| `execute_time_ms     ` |  1,238 |  4,952 |  1,387 |  883 |
| `trace_gen_time_ms   ` |  1,402 |  5,608 |  1,556 |  1,017 |
| `stark_prove_excluding_trace_time_ms` |  5,691 |  22,764 |  6,011 |  4,957 |
| `main_trace_commit_time_ms` |  1,121 |  4,484 |  1,208 |  911 |
| `generate_perm_trace_time_ms` |  277.25 |  1,109 |  336 |  208 |
| `perm_trace_commit_time_ms` |  812 |  3,248 |  866 |  705 |
| `quotient_poly_compute_time_ms` |  748.25 |  2,993 |  799 |  610 |
| `quotient_poly_commit_time_ms` |  958.25 |  3,833 |  1,039 |  868 |
| `pcs_opening_time_ms ` |  1,769 |  7,076 |  1,826 |  1,649 |

| internal.1 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,168.50 |  8,337 |  5,827 |  2,510 |
| `main_cells_used     ` |  77,149,864 |  154,299,728 |  115,072,502 |  39,227,226 |
| `total_cycles        ` |  1,559,123.50 |  3,118,247 |  2,338,808 |  779,439 |
| `execute_time_ms     ` |  438 |  876 |  654 |  222 |
| `trace_gen_time_ms   ` |  616 |  1,232 |  905 |  327 |
| `stark_prove_excluding_trace_time_ms` |  3,114.50 |  6,229 |  4,268 |  1,961 |
| `main_trace_commit_time_ms` |  559 |  1,118 |  813 |  305 |
| `generate_perm_trace_time_ms` |  133.50 |  267 |  179 |  88 |
| `perm_trace_commit_time_ms` |  409.50 |  819 |  586 |  233 |
| `quotient_poly_compute_time_ms` |  371 |  742 |  537 |  205 |
| `quotient_poly_commit_time_ms` |  604.50 |  1,209 |  752 |  457 |
| `pcs_opening_time_ms ` |  1,031.50 |  2,063 |  1,395 |  668 |

| internal.2 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,258 |  4,258 |  4,258 |  4,258 |
| `main_cells_used     ` |  75,829,950 |  75,829,950 |  75,829,950 |  75,829,950 |
| `total_cycles        ` |  1,542,919 |  1,542,919 |  1,542,919 |  1,542,919 |
...
| `main_cells_used     ` |  38,541,289 |  38,541,289 |  38,541,289 |  38,541,289 |
| `total_cycles        ` |  772,569 |  772,569 |  772,569 |  772,569 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  12,017 |  24,034 |  23,572 |  462 |
...
| `stark_prove_excluding_trace_time_ms` |  11,736.50 |  23,473 |  23,037 |  436 |
| `main_trace_commit_time_ms` |  3,443.50 |  6,887 |  6,836 |  51 |
| `generate_perm_trace_time_ms` |  48.50 |  97 |  83 |  14 |
| `perm_trace_commit_time_ms` |  2,181 |  4,362 |  4,321 |  41 |
| `quotient_poly_compute_time_ms` |  245 |  490 |  470 |  20 |
| `quotient_poly_commit_time_ms` |  4,313.50 |  8,627 |  8,575 |  52 |
| `pcs_opening_time_ms ` |  1,496 |  2,992 |  2,739 |  253 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 21000000 | 319 | 23,572 | 1,622,305 | 270,872,042 | 23,037 | 470 | 8,575 | 4,321 | 2,739 | 1 |  | 6,836 | 86,454,992 | 8,037,489 | 18,016 | 83 |  | 216 | 
| halo2_outer | 21000000 |  | 48,913 |  |  |  |  |  |  |  |  |  |  | 66,137,544 |  |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 21000000 | 0 | 1,533 | 8,676 | 3,499,675 | 472,992,226 | 5,834 | 799 | 954 | 839 | 1,797 | 1,186 | 208,467,630 | 255 |  | 1,309 | 
| internal.0 | 21000000 | 1 | 1,556 | 8,954 | 3,545,694 | 472,992,226 | 6,011 | 797 | 972 | 866 | 1,826 | 1,208 | 212,773,504 | 336 |  | 1,387 | 
| internal.0 | 21000000 | 2 | 1,502 | 8,837 | 3,530,518 | 472,992,226 | 5,962 | 787 | 1,039 | 838 | 1,804 | 1,179 | 211,603,567 | 310 |  | 1,373 | 
| internal.0 | 21000000 | 3 | 1,017 | 6,857 | 2,333,242 | 346,728,930 | 4,957 | 610 | 868 | 705 | 1,649 | 911 | 139,491,384 | 208 |  | 883 | 
| internal.1 | 21000000 | 4 | 905 | 5,827 | 2,338,808 | 302,819,810 | 4,268 | 537 | 752 | 586 | 1,395 | 813 | 115,072,502 | 179 |  | 654 | 
| internal.1 | 21000000 | 5 | 327 | 2,510 | 779,439 | 95,656,418 | 1,961 | 205 | 457 | 233 | 668 | 305 | 39,227,226 | 88 |  | 222 | 
| internal.2 | 21000000 | 6 | 616 | 4,258 | 1,542,919 | 186,591,714 | 3,218 | 367 | 635 | 499 | 1,028 | 522 | 75,829,950 | 161 |  | 424 | 
| leaf | 21000000 | 0 | 1,214 | 5,532 | 2,022,972 | 664,751,594 | 3,596 | 410 | 344 | 768 | 1,189 | 624 | 156,402,894 | 257 |  | 722 | 
| leaf | 21000000 | 1 | 1,265 | 5,842 | 2,102,254 | 732,909,034 | 3,848 | 450 | 375 | 806 | 1,230 | 702 | 159,296,046 | 280 |  | 729 | 
| leaf | 21000000 | 10 | 1,237 | 5,314 | 2,027,984 | 571,690,474 | 3,394 | 385 | 348 | 711 | 1,170 | 524 | 154,560,388 | 250 |  | 683 | 
