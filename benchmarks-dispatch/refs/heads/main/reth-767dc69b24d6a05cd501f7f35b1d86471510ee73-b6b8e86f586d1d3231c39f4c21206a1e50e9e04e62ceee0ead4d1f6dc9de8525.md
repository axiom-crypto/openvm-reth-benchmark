...
|:---|---:|---:|
| Total |  533.48 |  174.86 |
| reth.prove_e2e.block_21000000 |  282.89 |  37.81 |
| leaf |  85.03 |  10.10 |
| internal.0 |  37.06 |  7.75 |
...
| `total_proof_time_ms ` |  28,289.20 |  282,892 |  37,808 |  7,256 |
| `main_cells_used     ` |  1,240,420,081.60 |  12,404,200,816 |  2,126,805,722 |  289,826,175 |
| `total_cycles        ` |  19,583,766.10 |  195,837,661 |  24,830,749 |  1,960,889 |
| `execute_time_ms     ` |  3,014.80 |  30,148 |  5,989 |  277 |
| `trace_gen_time_ms   ` |  9,230.30 |  92,303 |  11,146 |  3,141 |
| `stark_prove_excluding_trace_time_ms` |  16,044.10 |  160,441 |  24,983 |  3,838 |
| `main_trace_commit_time_ms` |  3,738 |  37,380 |  7,462 |  844 |
| `generate_perm_trace_time_ms` |  863.50 |  8,635 |  1,140 |  151 |
| `perm_trace_commit_time_ms` |  4,023.40 |  40,234 |  5,633 |  714 |
| `quotient_poly_compute_time_ms` |  2,981.10 |  29,811 |  5,922 |  632 |
| `quotient_poly_commit_time_ms` |  1,273.10 |  12,731 |  1,519 |  418 |
| `pcs_opening_time_ms ` |  3,151.40 |  31,514 |  3,647 |  1,069 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,502.70 |  85,027 |  10,103 |  6,188 |
| `main_cells_used     ` |  229,423,611.50 |  2,294,236,115 |  279,569,452 |  157,828,557 |
| `total_cycles        ` |  2,871,846 |  28,718,460 |  3,458,660 |  2,040,073 |
| `execute_time_ms     ` |  953.90 |  9,539 |  1,116 |  717 |
| `trace_gen_time_ms   ` |  1,751.50 |  17,515 |  2,146 |  1,217 |
| `stark_prove_excluding_trace_time_ms` |  5,797.30 |  57,973 |  6,860 |  4,189 |
| `main_trace_commit_time_ms` |  894.80 |  8,948 |  1,057 |  621 |
| `generate_perm_trace_time_ms` |  337.70 |  3,377 |  407 |  232 |
| `perm_trace_commit_time_ms` |  1,702.70 |  17,027 |  2,030 |  1,163 |
| `quotient_poly_compute_time_ms` |  855.50 |  8,555 |  1,014 |  616 |
| `quotient_poly_commit_time_ms` |  631.10 |  6,311 |  755 |  453 |
| `pcs_opening_time_ms ` |  1,370.80 |  13,708 |  1,615 |  1,014 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,412 |  37,060 |  7,745 |  7,154 |
| `main_cells_used     ` |  142,215,000.20 |  711,075,001 |  143,303,481 |  140,384,460 |
| `total_cycles        ` |  2,382,508.60 |  11,912,543 |  2,395,540 |  2,363,124 |
| `execute_time_ms     ` |  934 |  4,670 |  954 |  914 |
| `trace_gen_time_ms   ` |  1,049.40 |  5,247 |  1,075 |  1,027 |
| `stark_prove_excluding_trace_time_ms` |  5,428.60 |  27,143 |  5,740 |  5,199 |
| `main_trace_commit_time_ms` |  1,016.40 |  5,082 |  1,125 |  940 |
| `generate_perm_trace_time_ms` |  196 |  980 |  224 |  180 |
| `perm_trace_commit_time_ms` |  920.40 |  4,602 |  976 |  883 |
| `quotient_poly_compute_time_ms` |  904.60 |  4,523 |  967 |  857 |
| `quotient_poly_commit_time_ms` |  1,061 |  5,305 |  1,100 |  1,023 |
| `pcs_opening_time_ms ` |  1,325.20 |  6,626 |  1,361 |  1,301 |

| internal.1 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,662.33 |  10,987 |  4,232 |  2,583 |
| `main_cells_used     ` |  62,946,437 |  188,839,311 |  75,226,065 |  38,415,167 |
| `total_cycles        ` |  1,275,336.33 |  3,826,009 |  1,530,425 |  765,386 |
| `execute_time_ms     ` |  365 |  1,095 |  438 |  219 |
| `trace_gen_time_ms   ` |  499.33 |  1,498 |  607 |  311 |
| `stark_prove_excluding_trace_time_ms` |  2,798 |  8,394 |  3,187 |  2,053 |
| `main_trace_commit_time_ms` |  458 |  1,374 |  528 |  319 |
| `generate_perm_trace_time_ms` |  82.33 |  247 |  105 |  50 |
| `perm_trace_commit_time_ms` |  417 |  1,251 |  484 |  285 |
| `quotient_poly_compute_time_ms` |  420.33 |  1,261 |  492 |  279 |
| `quotient_poly_commit_time_ms` |  629.33 |  1,888 |  708 |  482 |
| `pcs_opening_time_ms ` |  786.67 |  2,360 |  865 |  634 |

| internal.2 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,380 |  6,760 |  4,214 |  2,546 |
| `main_cells_used     ` |  55,441,417 |  110,882,834 |  73,817,990 |  37,064,844 |
| `total_cycles        ` |  1,132,587 |  2,265,174 |  1,515,099 |  750,075 |
| `execute_time_ms     ` |  307.50 |  615 |  414 |  201 |
| `trace_gen_time_ms   ` |  461.50 |  923 |  603 |  320 |
| `stark_prove_excluding_trace_time_ms` |  2,611 |  5,222 |  3,197 |  2,025 |
| `main_trace_commit_time_ms` |  430.50 |  861 |  529 |  332 |
| `generate_perm_trace_time_ms` |  82 |  164 |  101 |  63 |
| `perm_trace_commit_time_ms` |  386 |  772 |  489 |  283 |
| `quotient_poly_compute_time_ms` |  379 |  758 |  483 |  275 |
| `quotient_poly_commit_time_ms` |  606.50 |  1,213 |  729 |  484 |
...
| `main_cells_used     ` |  73,291,653 |  73,291,653 |  73,291,653 |  73,291,653 |
| `total_cycles        ` |  1,507,232 |  1,507,232 |  1,507,232 |  1,507,232 |
...
| `quotient_poly_commit_time_ms` |  8,095 |  8,095 |  8,095 |  8,095 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,667.50 |  23,335 |  22,896 |  439 |
...
| `stark_prove_excluding_trace_time_ms` |  11,388 |  22,776 |  22,363 |  413 |
...
| `quotient_poly_commit_time_ms` |  4,110.50 |  8,221 |  8,162 |  59 |
| `pcs_opening_time_ms ` |  1,303.50 |  2,607 |  2,407 |  200 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 21000000 | 324 | 22,896 | 1,636,532 | 269,692,394 | 22,363 | 560 | 8,162 | 4,325 | 2,407 | 1 | 6,850 | 87,084,064 | 8,037,489 | 17,624 | 52 | 209 | 
| halo2_outer | 21000000 |  | 48,676 |  |  |  |  |  |  |  |  |  | 61,870,615 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 21000000 | 0 | 1