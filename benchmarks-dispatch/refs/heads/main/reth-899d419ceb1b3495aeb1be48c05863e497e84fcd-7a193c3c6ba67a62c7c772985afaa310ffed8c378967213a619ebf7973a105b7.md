...
|:---|---:|---:|
| Total |  152.71 |  152.71 |
| reth.prove_e2e.block_21345144 |  28.84 |  28.84 |
| leaf |  10.03 |  10.03 |
| internal.0 |  4.55 |  4.55 |
| root |  23.08 |  23.08 |
...
| `total_proof_time_ms ` |  28,843 |  28,843 |  28,843 |  28,843 |
| `main_cells_used     ` |  1,290,611,522 |  1,290,611,522 |  1,290,611,522 |  1,290,611,522 |
| `total_cycles        ` |  20,841,757 |  20,841,757 |  20,841,757 |  20,841,757 |
| `execute_time_ms     ` |  3,029 |  3,029 |  3,029 |  3,029 |
| `trace_gen_time_ms   ` |  8,829 |  8,829 |  8,829 |  8,829 |
| `stark_prove_excluding_trace_time_ms` |  16,985 |  16,985 |  16,985 |  16,985 |
| `main_trace_commit_time_ms` |  3,760 |  3,760 |  3,760 |  3,760 |
| `generate_perm_trace_time_ms` |  935 |  935 |  935 |  935 |
| `perm_trace_commit_time_ms` |  4,509 |  4,509 |  4,509 |  4,509 |
| `quotient_poly_compute_time_ms` |  3,024 |  3,024 |  3,024 |  3,024 |
| `quotient_poly_commit_time_ms` |  1,443 |  1,443 |  1,443 |  1,443 |
| `pcs_opening_time_ms ` |  3,296 |  3,296 |  3,296 |  3,296 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,026 |  10,026 |  10,026 |  10,026 |
| `main_cells_used     ` |  284,984,929 |  284,984,929 |  284,984,929 |  284,984,929 |
| `total_cycles        ` |  3,538,990 |  3,538,990 |  3,538,990 |  3,538,990 |
| `execute_time_ms     ` |  1,099 |  1,099 |  1,099 |  1,099 |
| `trace_gen_time_ms   ` |  2,116 |  2,116 |  2,116 |  2,116 |
| `stark_prove_excluding_trace_time_ms` |  6,811 |  6,811 |  6,811 |  6,811 |
| `main_trace_commit_time_ms` |  1,054 |  1,054 |  1,054 |  1,054 |
| `generate_perm_trace_time_ms` |  357 |  357 |  357 |  357 |
| `perm_trace_commit_time_ms` |  2,027 |  2,027 |  2,027 |  2,027 |
| `quotient_poly_compute_time_ms` |  1,007 |  1,007 |  1,007 |  1,007 |
| `quotient_poly_commit_time_ms` |  739 |  739 |  739 |  739 |
| `pcs_opening_time_ms ` |  1,624 |  1,624 |  1,624 |  1,624 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,552 |  4,552 |  4,552 |  4,552 |
| `main_cells_used     ` |  72,458,786 |  72,458,786 |  72,458,786 |  72,458,786 |
| `total_cycles        ` |  1,199,298 |  1,199,298 |  1,199,298 |  1,199,298 |
| `execute_time_ms     ` |  468 |  468 |  468 |  468 |
| `trace_gen_time_ms   ` |  565 |  565 |  565 |  565 |
| `stark_prove_excluding_trace_time_ms` |  3,519 |  3,519 |  3,519 |  3,519 |
| `main_trace_commit_time_ms` |  623 |  623 |  623 |  623 |
| `generate_perm_trace_time_ms` |  128 |  128 |  128 |  128 |
| `perm_trace_commit_time_ms` |  553 |  553 |  553 |  553 |
...
| `main_cells_used     ` |  37,488,526 |  37,488,526 |  37,488,526 |  37,488,526 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  50,464 |  50,464 |  50,464 |  50,464 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,922 |  23,844 |  23,396 |  448 |
...
| `stark_prove_excluding_trace_time_ms` |  11,641.50 |  23,283 |  22,862 |  421 |
...
| `quotient_poly_commit_time_ms` |  4,301.50 |  8,603 |  8,546 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 21345144 | 323 | 23,396 | 1,636,751 | 270,872,042 | 22,862 | 576 | 8,546 | 4,263 | 2,524 | 1 | 6,873 | 86,881,443 | 8,037,489 | 18,073 | 62 | 211 | 
| halo2_outer | 21345144 |  | 50,464 |  |  |  |  |  |  |  |  |  | 62,800,919 |  |  |  |  | 
| halo2_wrapper | 21345144 |  | 35,751 |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 
...
| agg_keygen | 21345144 | VerifierProgram;stage-d-verify-pcs;stage-d-verifier-verify;compute-reduced-opening;single-reduced-opening-eval | 7,994,476 | 335,356 | 1,482,124 | 
...
| agg_keygen | 21345144 | VerifierProgram;stage-d-verify-pcs;stage-d-verifier-verify;verify-batch;PoseidonCell | 9,264,780 |  | 2,744,280 | 
| agg_keygen | 21345144 | VerifierProgram;stage-d-verify-pcs;stage-d-verifier-verify;verify-batch;verify-batch-reduce-fast;PoseidonCell | 8,263,864 | 237,048 | 2,580,396 | 
| agg_keygen | 21345144 | VerifierProgram;stage-d-verify-pcs;stage-d-verifier-verify;verify-query | 953,456 | 165,676 | 272,356 | 
...
| agg_keygen | 21345144 | VerifierProgram;stage-d-verify-pcs;stage-d-verifier-verify;verify-query;verify-batch-ext;verify-batch-reduce-fast;PoseidonCell | 1,550,612 | 56,000 | 476,812 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 21345144 | 0 | 565 | 4,552 | 1,199,298 | 224,975,330 | 3,519 | 562 | 775 | 553 | 873 | 623 | 72,458,786 | 128 | 468 | 
| leaf | 21345144 | 0 | 2,116 | 10,026 | 3,538,990 | 1,100,058,090 | 6,811 | 1,007 | 739 | 2,027 | 1,624 | 1,054 | 284,984,929 | 357 | 1,099 | 
| root | 21345144 | 0 | 318 | 23,079 | 759,197 | 80,435,354 | 22,552 | 571 | 8,364 | 4,285 | 2,408 | 6,868 | 37,488,526 | 45 | 209 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 21345144 | 0 | 27 | 448 |  | 7,747,601 | 421 | 30 | 57 | 51 | 215 | 51 | 10,556 | 13 | 0 | 
| reth.prove_e2e.block_21345144 | 21345144 | 0 | 8,829 | 28,843 | 20,841,757 | 2,999,286,129 | 16,985 | 3,024 | 1,443 | 4,509 | 3,296 | 3,760 | 1,290,611,522 | 935 | 3,029 | 
...
Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/actions/runs/14423766861
