...
|:---|---:|---:|
| Total |  609.20 |  200.28 |
| reth.prove_evm.block_21000000 |  313.98 |  36.66 |
| leaf |  105.35 |  11.46 |
| internal.0 |  45.67 |  12.11 |
| internal.1 |  12.41 |  8.26 |
| internal.2 |  6 |  6 |
| root |  30.81 |  30.81 |
| halo2_outer |  56.41 |  56.41 |
| halo2_wrapper |  38.56 |  38.56 |
| agg_keygen |  31.59 |  30.84 |


| reth.prove_evm.block_21000000 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  28,543.82 |  313,982 |  36,659 |  15,734 |
| `main_cells_used     ` |  1,152,786,067.55 |  12,680,646,743 |  1,513,541,176 |  734,490,412 |
| `total_cycles        ` |  18,582,180.27 |  204,403,983 |  24,897,409 |  4,949,486 |
| `execute_time_ms     ` |  2,898.91 |  31,888 |  6,186 |  740 |
| `trace_gen_time_ms   ` |  9,109 |  100,199 |  11,518 |  4,756 |
| `stark_prove_excluding_trace_time_ms` |  16,535.91 |  181,895 |  19,929 |  9,981 |
| `main_trace_commit_time_ms` |  4,091.09 |  45,002 |  6,888 |  2,940 |
| `generate_perm_trace_time_ms` |  1,028.82 |  11,317 |  1,291 |  404 |
| `perm_trace_commit_time_ms` |  3,114.91 |  34,264 |  3,827 |  1,444 |
| `quotient_poly_compute_time_ms` |  3,086.45 |  33,951 |  5,753 |  2,222 |
| `quotient_poly_commit_time_ms` |  1,284.55 |  14,130 |  1,596 |  799 |
| `pcs_opening_time_ms ` |  3,917.45 |  43,092 |  4,651 |  2,163 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  9,577 |  105,347 |  11,455 |  7,045 |
| `main_cells_used     ` |  222,475,631.55 |  2,447,231,947 |  278,431,886 |  155,252,233 |
| `total_cycles        ` |  2,809,167.55 |  30,900,843 |  3,459,167 |  2,024,368 |
| `execute_time_ms     ` |  1,252.45 |  13,777 |  1,446 |  1,032 |
| `trace_gen_time_ms   ` |  1,866.55 |  20,532 |  2,282 |  1,344 |
| `stark_prove_excluding_trace_time_ms` |  6,458 |  71,038 |  7,763 |  4,669 |
| `main_trace_commit_time_ms` |  1,118.82 |  12,307 |  1,358 |  769 |
| `generate_perm_trace_time_ms` |  408 |  4,488 |  527 |  247 |
| `perm_trace_commit_time_ms` |  1,471.09 |  16,182 |  1,818 |  988 |
| `quotient_poly_compute_time_ms` |  895.09 |  9,846 |  1,091 |  608 |
| `quotient_poly_commit_time_ms` |  696.45 |  7,661 |  832 |  552 |
| `pcs_opening_time_ms ` |  1,864.09 |  20,505 |  2,273 |  1,475 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,417 |  45,668 |  12,114 |  9,455 |
| `main_cells_used     ` |  194,828,522 |  779,314,088 |  214,269,020 |  140,443,814 |
| `total_cycles        ` |  3,276,556.25 |  13,106,225 |  3,596,341 |  2,365,565 |
| `execute_time_ms     ` |  2,036 |  8,144 |  2,250 |  1,431 |
| `trace_gen_time_ms   ` |  1,572.75 |  6,291 |  1,716 |  1,170 |
| `stark_prove_excluding_trace_time_ms` |  7,808.25 |  31,233 |  8,165 |  6,854 |
| `main_trace_commit_time_ms` |  1,533.75 |  6,135 |  1,630 |  1,287 |
| `generate_perm_trace_time_ms` |  283 |  1,132 |  336 |  235 |
| `perm_trace_commit_time_ms` |  1,181.50 |  4,726 |  1,250 |  1,056 |
| `quotient_poly_compute_time_ms` |  1,214.50 |  4,858 |  1,303 |  998 |
| `quotient_poly_commit_time_ms` |  1,531.50 |  6,126 |  1,603 |  1,381 |
| `pcs_opening_time_ms ` |  2,058.75 |  8,235 |  2,129 |  1,892 |

| internal.1 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,207.50 |  12,415 |  8,262 |  4,153 |
| `main_cells_used     ` |  75,079,262 |  150,158,524 |  111,971,569 |  38,186,955 |
| `total_cycles        ` |  1,532,534 |  3,065,068 |  2,298,918 |  766,150 |
| `execute_time_ms     ` |  663.50 |  1,327 |  997 |  330 |
| `trace_gen_time_ms   ` |  668 |  1,336 |  973 |  363 |
| `stark_prove_excluding_trace_time_ms` |  4,876 |  9,752 |  6,292 |  3,460 |
| `main_trace_commit_time_ms` |  840.50 |  1,681 |  1,167 |  514 |
| `generate_perm_trace_time_ms` |  152 |  304 |  231 |  73 |
| `perm_trace_commit_time_ms` |  667.50 |  1,335 |  896 |  439 |
| `quotient_poly_compute_time_ms` |  603.50 |  1,207 |  854 |  353 |
| `quotient_poly_commit_time_ms` |  1,155 |  2,310 |  1,326 |  984 |
| `pcs_opening_time_ms ` |  1,451 |  2,902 |  1,811 |  1,091 |

| internal.2 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,003 |  6,003 |  6,003 |  6,003 |
| `main_cells_used     ` |  73,851,102 |  73,851,102 |  73,851,102 |  73,851,102 |
| `total_cycles        ` |  1,516,232 |  1,516,232 |  1,516,232 |  1,516,232 |
| `execute_time_ms     ` |  638 |  638 |  638 |  638 |
| `trace_gen_time_ms   ` |  677 |  677 |  677 |  677 |
| `stark_prove_excluding_trace_time_ms` |  4,688 |  4,688 |  4,688 |  4,688 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  30,813 |  30,813 |  30,813 |  30,813 |
...
| `stark_prove_excluding_trace_time_ms` |  30,144 |  30,144 |  30,144 |  30,144 |
| `main_trace_commit_time_ms` |  8,855 |  8,855 |  8,855 |  8,855 |
| `generate_perm_trace_time_ms` |  107 |  107 |  107 |  107 |
| `perm_trace_commit_time_ms` |  5,545 |  5,545 |  5,545 |  5,545 |
| `quotient_poly_compute_time_ms` |  781 |  781 |  781 |  781 |
| `quotient_poly_commit_time_ms` |  11,395 |  11,395 |  11,395 |  11,395 |
| `pcs_opening_time_ms ` |  3,447 |  3,447 |  3,447 |  3,447 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  56,406 |  56,406 |  56,406 |  56,406 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  15,796.50 |  31,593 |  30,835 |  758 |
...
| `stark_prove_excluding_trace_time_ms` |  15,443.50 |  30,887 |  30,154 |  733 |
| `main_trace_commit_time_ms` |  4,454 |  8,908 |  8,819 |  89 |
| `generate_perm_trace_time_ms` |  48.50 |  97 |  77 |  20 |
| `perm_trace_commit_time_ms` |  2,826 |  5,652 |  5,575 |  77 |
| `quotient_poly_compute_time_ms` |  407.50 |  815 |  779 |  36 |
| `quotient_poly_commit_time_ms` |  5,678.50 |  11,357 |  11,244 |  113 |
| `pcs_opening_time_ms ` |  2,023 |  4,046 |  3,653 |  393 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 21000000 | 363 |