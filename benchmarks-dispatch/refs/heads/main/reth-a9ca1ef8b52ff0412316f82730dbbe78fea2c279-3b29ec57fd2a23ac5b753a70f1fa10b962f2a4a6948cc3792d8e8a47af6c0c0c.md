...
|:---|---:|---:|
| Total |  554.08 |  172.84 |
| reth.prove_e2e.block_21000000 |  292.53 |  35.88 |
| leaf |  89.80 |  10.07 |
| internal.0 |  41.33 |  7.73 |
| internal.1 |  12.91 |  4.36 |
| internal.2 |  6.90 |  4.19 |
...
| `total_proof_time_ms ` |  26,593.55 |  292,529 |  35,875 |  7,258 |
| `main_cells_used     ` |  1,153,549,127.09 |  12,689,040,398 |  1,939,129,625 |  290,279,067 |
| `total_cycles        ` |  18,540,101.64 |  203,941,118 |  24,818,528 |  1,960,914 |
| `execute_time_ms     ` |  2,839.27 |  31,232 |  5,996 |  281 |
| `trace_gen_time_ms   ` |  8,549.82 |  94,048 |  10,824 |  3,139 |
| `stark_prove_excluding_trace_time_ms` |  15,204.45 |  167,249 |  24,338 |  3,838 |
| `main_trace_commit_time_ms` |  3,524 |  38,764 |  7,529 |  855 |
| `generate_perm_trace_time_ms` |  817.82 |  8,996 |  1,098 |  130 |
| `perm_trace_commit_time_ms` |  3,800.55 |  41,806 |  5,220 |  721 |
| `quotient_poly_compute_time_ms` |  2,794 |  30,734 |  5,786 |  642 |
| `quotient_poly_commit_time_ms` |  1,222.55 |  13,448 |  1,538 |  397 |
| `pcs_opening_time_ms ` |  3,032.27 |  33,355 |  3,595 |  1,084 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,163.73 |  89,801 |  10,073 |  5,782 |
| `main_cells_used     ` |  222,240,890.91 |  2,444,649,800 |  279,008,855 |  155,834,533 |
| `total_cycles        ` |  2,794,295.55 |  30,737,251 |  3,458,280 |  2,023,562 |
| `execute_time_ms     ` |  933.36 |  10,267 |  1,114 |  720 |
| `trace_gen_time_ms   ` |  1,692.36 |  18,616 |  2,146 |  1,221 |
| `stark_prove_excluding_trace_time_ms` |  5,538 |  60,918 |  6,825 |  3,805 |
| `main_trace_commit_time_ms` |  854.27 |  9,397 |  1,046 |  563 |
| `generate_perm_trace_time_ms` |  327.55 |  3,603 |  416 |  223 |
| `perm_trace_commit_time_ms` |  1,650.27 |  18,153 |  2,077 |  1,083 |
| `quotient_poly_compute_time_ms` |  807.36 |  8,881 |  1,003 |  546 |
| `quotient_poly_commit_time_ms` |  599 |  6,589 |  738 |  440 |
| `pcs_opening_time_ms ` |  1,294.73 |  14,242 |  1,573 |  944 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,888 |  41,328 |  7,732 |  4,344 |
| `main_cells_used     ` |  130,264,838 |  781,589,028 |  143,143,655 |  71,030,282 |
| `total_cycles        ` |  2,182,429.67 |  13,094,578 |  2,395,493 |  1,181,922 |
| `execute_time_ms     ` |  856.83 |  5,141 |  958 |  458 |
| `trace_gen_time_ms   ` |  963.17 |  5,779 |  1,078 |  537 |
| `stark_prove_excluding_trace_time_ms` |  5,068 |  30,408 |  5,735 |  3,349 |
| `main_trace_commit_time_ms` |  941.67 |  5,650 |  1,127 |  540 |
| `generate_perm_trace_time_ms` |  173.33 |  1,040 |  209 |  101 |
| `perm_trace_commit_time_ms` |  851.67 |  5,110 |  992 |  504 |
| `quotient_poly_compute_time_ms` |  837.33 |  5,024 |  972 |  509 |
| `quotient_poly_commit_time_ms` |  995.50 |  5,973 |  1,081 |  737 |
| `pcs_opening_time_ms ` |  1,264.17 |  7,585 |  1,368 |  954 |

| internal.1 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,302.67 |  12,908 |  4,356 |  4,251 |
| `main_cells_used     ` |  75,026,522 |  225,079,566 |  75,223,273 |  74,658,598 |
| `total_cycles        ` |  1,527,690.33 |  4,583,071 |  1,530,393 |  1,522,595 |
| `execute_time_ms     ` |  433 |  1,299 |  435 |  431 |
| `trace_gen_time_ms   ` |  608.33 |  1,825 |  616 |  602 |
| `stark_prove_excluding_trace_time_ms` |  3,261.33 |  9,784 |  3,318 |  3,214 |
| `main_trace_commit_time_ms` |  536.33 |  1,609 |  541 |  533 |
| `generate_perm_trace_time_ms` |  92.67 |  278 |  94 |  91 |
| `perm_trace_commit_time_ms` |  487.33 |  1,462 |  489 |  485 |
| `quotient_poly_compute_time_ms` |  495.33 |  1,486 |  507 |  489 |
| `quotient_poly_commit_time_ms` |  746.33 |  2,239 |  763 |  720 |
| `pcs_opening_time_ms ` |  898 |  2,694 |  927 |  882 |

| internal.2 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,448 |  6,896 |  4,186 |  2,710 |
| `main_cells_used     ` |  55,773,067 |  111,546,134 |  73,817,162 |  37,728,972 |
| `total_cycles        ` |  1,136,471 |  2,272,942 |  1,515,030 |  757,912 |
| `execute_time_ms     ` |  313 |  626 |  415 |  211 |
| `trace_gen_time_ms   ` |  451 |  902 |  578 |  324 |
| `stark_prove_excluding_trace_time_ms` |  2,684 |  5,368 |  3,193 |  2,175 |
| `main_trace_commit_time_ms` |  429 |  858 |  535 |  323 |
| `generate_perm_trace_time_ms` |  78.50 |  157 |  109 |  48 |
| `perm_trace_commit_time_ms` |  388.50 |  777 |  489 |  288 |
| `quotient_poly_compute_time_ms` |  384.50 |  769 |  488 |  281 |
| `quotient_poly_commit_time_ms` |  638.50 |  1,277 |  697 |  580 |
| `pcs_opening_time_ms ` |  760.50 |  1,521 |  872 |  649 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,688.50 |  23,377 |  22,938 |  439 |
...
| `stark_prove_excluding_trace_time_ms` |  11,413.50 |  22,827 |  22,416 |  411 |
...
| `quotient_poly_commit_time_ms` |  4,126.50 |  8,253 |  8,193 |  60 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 21000000 | 312 | 22,938 | 1,636,524 | 269,692,394 | 22,416 | 560 | 8,193 | 4,277 | 2,443 | 1 | 6,877 | 87,083,968 | 8,037,489 | 17,746 | 50 | 210 | 
| halo2_outer | 21000000 |  | 48,209 |  |  |  |  |  |  |  |  |  | 61,870,615 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 21000000 | 0 | 1,066 | 7,233 | 2,379,268 | 345,876,962 | 5,239 | 871 | 1,027 | 880 | 1,312 | 967 | 142,002,912 | 178 | 928 | 
| internal.0 | 21000000 | 1 | 1,026 | 7,117 | 2,363,069 | 345,418,210 | 5,181 | 860 | 1,026 | 880 | 1,292 | 945 | 140,382,487 | 173 | 910 | 
| internal.0 | 21000000 | 2 | 1,078 | 7,722 | 2,395,471 | 419,015,138 | 5,692 | 957 | 1,081 | 981 | 1,341 | 1,127 | 143,143,391 | 201 | 952 | 
| leaf | 21000000 | 6 | 2,139 | 10,073 | 3,457,578 | 1,071,746,538 | 6,825 | 1,003 | 738 | 2,077 | 1,560 | 1,036 | 279,008,855 | 407 | 1,109 | 
| leaf | 21000000 | 7 | 2,060 | 9,912 | 3,377,953 | 1,071,746,538 | 6,750 | 987 | 722 | 2,044 | 1,559 | 1,033 | 275,791,271 | 399 | 1,102 | 
| leaf | 21000000 | 8 | 2,081 | 9,975 | 3,417,908 | 1,071,746,538 | 6,784 | 990 | 723 | 2,066 | 1,567 | 1,033 | 277,510,080 | 401 | 1,110 | 
| leaf | 21000000 | 9 | 1,387 | 6,652 | 2,336,864 | 722,685,418 | 4,468 | 666 | 479 | 1,310 | 1,030 | 719 | 175,441,044 | 259 | 797 | 
| root | 21000000 | 0 | 327 | 22,930 | 758,354 | 80,304,282 | 22,393 | 560 | 8,190 | 4,265 | 2,439 | 6,867 | 37,732,383 | 53 | 210 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 21000000 | 0 | 28 | 439 |  | 7,747,601 | 411 | 30 | 60 | 52 | 203 | 51 | 928,071 | 12 | 0 | 
| reth.prove_e2e.block_21000000 | 21000000 | 0 | 8,498 | 25,529 | 20,424,422 | 2,557,907,225 | 14,286 | 2,125 | 1,358 | 3,851 | 3,113 | 2,916 | 994,539,570 | 907 | 2,745 | 
| reth.prove_e2e.block_21000000 | 21000000 | 1 | 8,781 | 25,430 | 20,434,219 | 2,558,016,183 | 13,935 | 2,118 | 1,251 | 3,732 | 3,175 | 2,795 | 991,746,165 | 855 | 2,714 | 
| reth.prove_e2e.block_21000000 | 21000000 | 10 | 3,139 | 7,258 | 1,960,914 | 589,214,668 | 3,838 | 642 | 397 | 721 | 1,084 | 855 | 290,279,067 | 130 | 281 | 
| reth.prove_e2e.block_21000000 | 21000000 | 2 | 8,937 | 25,440 | 20,453,409 | 2,558,327,991 | 13,798 | 2,094 | 1,265 | 3,684 | 3,144 | 2,791 | 993,299,717 | 811 | 2,705 | 
| reth.prove_e2e.block_21000000 | 21000000 | 3 | 4,527 | 22,705 | 5,876,079 | 3,341,267,022 | 17,354 | 4,680 | 766 | 3,299 | 1,997 | 5,956 | 1,454,810,676 | 646 | 824 | 
| reth.prove_e2e.block_21000000 | 21000000 | 4 | 9,625 | 33,481 | 23,439,171 | 3,352,735,978 | 17,860 | 3,314 | 1,447 | 4,639 | 3,556 | 3,916 | 1,357,339,110 | 971 | 5,996 | 
| reth.prove_e2e.block_21000000 | 21000000 | 5 | 9,780 | 28,026 | 23,882,763 | 2,713,928,870 | 15,104 | 2,378 | 1,391 | 4,056 | 3,497 | 2,857 | 1,098,194,978 | 909 | 3,142 | 
| reth.prove_e2e.block_21000000 | 21000000 | 6 | 10,824 | 30,382 | 24,818,528 | 2,902,364,170 | 16,138 | 2,547 | 1,538 | 4,406 | 3,595 | 3,106 | 1,156,842,383 | 928 | 3,420 | 
| reth.prove_e2e.block_21000000 | 21000000 | 7 | 10,332 | 28,586 | 24,327,870 | 2,696,179,682 | 14,895 | 2,360 | 1,388 | 4,009 | 3,419 | 2,846 | 1,121,879,746 | 856 | 3,359 | 
| reth.prove_e2e.block_21000000 | 21000000 | 8 | 10,784 | 29,817 | 24,013,962 | 2,884,998,026 | 15,703 | 2,690 | 1,322 | 4,189 | 3,404 | 3,197 | 1,290,979,361 | 885 | 3,330 | 
| reth.prove_e2e.block_21000000 | 21000000 | 9 | 8,821 | 35,875 | 14,309,781 | 4,957,707,962 | 24,338 | 5,786 | 1,325 | 5,220 | 3,371 | 7,529 | 1,939,129,625 | 1,098 | 2,716 | 
...
Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/a9ca1ef8b52ff0412316f82730dbbe78fea2c279
