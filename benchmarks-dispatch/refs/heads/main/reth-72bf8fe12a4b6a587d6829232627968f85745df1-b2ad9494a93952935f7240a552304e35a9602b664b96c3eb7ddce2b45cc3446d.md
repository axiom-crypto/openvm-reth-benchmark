...
|:---|---:|---:|
| Total |  804.60 |  227.98 |
| reth.prove_e2e.block_21000000 |  486.62 |  63.29 |
| leaf |  120.43 |  14.40 |
| internal.0 |  36.69 |  6.52 |
| internal.1 |  19.04 |  6.43 |
| internal.2 |  10.88 |  6.41 |
| internal.3 |  6.37 |  6.37 |
| internal.4 |  4.41 |  4.41 |
| root |  29.11 |  29.11 |
| halo2_outer |  52.59 |  52.59 |
| halo2_wrapper |  38.45 |  38.45 |
| agg_keygen |  31.36 |  30.45 |


| reth.prove_e2e.block_21000000 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,238.18 |  486,620 |  63,287 |  12,761 |
| `main_cells_used     ` |  1,143,793,148.36 |  12,581,724,632 |  1,923,770,141 |  289,468,686 |
| `total_cycles        ` |  1,959,963 |  1,959,963 |  1,959,963 |  1,959,963 |
| `execute_time_ms     ` |  3,037.45 |  33,412 |  6,364 |  280 |
| `trace_gen_time_ms   ` |  9,251.09 |  101,762 |  11,705 |  3,170 |
| `stark_prove_excluding_trace_time_ms` |  31,949.64 |  351,446 |  50,629 |  9,311 |
| `main_trace_commit_time_ms` |  8,086.73 |  88,954 |  17,007 |  2,170 |
| `generate_perm_trace_time_ms` |  1,016 |  11,176 |  1,396 |  218 |
| `perm_trace_commit_time_ms` |  4,634.64 |  50,981 |  5,742 |  1,255 |
| `quotient_poly_compute_time_ms` |  6,205.18 |  68,257 |  13,497 |  1,249 |
| `quotient_poly_commit_time_ms` |  5,109.55 |  56,205 |  6,395 |  1,937 |
| `pcs_opening_time_ms ` |  6,884.45 |  75,729 |  8,194 |  2,468 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,947.91 |  120,427 |  14,396 |  9,453 |
| `main_cells_used     ` |  115,697,857.55 |  1,272,676,433 |  171,140,492 |  81,973,905 |
| `total_cycles        ` |  1,528,649.55 |  16,815,145 |  2,247,110 |  1,036,986 |
| `execute_time_ms     ` |  571.45 |  6,286 |  724 |  462 |
| `trace_gen_time_ms   ` |  1,097 |  12,067 |  1,550 |  814 |
| `stark_prove_excluding_trace_time_ms` |  9,279.45 |  102,074 |  12,122 |  8,136 |
| `main_trace_commit_time_ms` |  1,516.82 |  16,685 |  2,073 |  1,303 |
| `generate_perm_trace_time_ms` |  243.27 |  2,676 |  325 |  154 |
| `perm_trace_commit_time_ms` |  1,374 |  15,114 |  1,983 |  1,143 |
| `quotient_poly_compute_time_ms` |  1,019.82 |  11,218 |  1,610 |  794 |
| `quotient_poly_commit_time_ms` |  2,161.64 |  23,778 |  2,749 |  1,962 |
| `pcs_opening_time_ms ` |  2,960 |  32,560 |  3,379 |  2,756 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,115.67 |  36,694 |  6,521 |  4,436 |
| `main_cells_used     ` |  63,700,266.50 |  382,201,599 |  69,402,771 |  35,532,639 |
| `total_cycles        ` |  1,137,781.83 |  6,826,691 |  1,241,570 |  620,621 |
| `execute_time_ms     ` |  630.50 |  3,783 |  697 |  347 |
| `trace_gen_time_ms   ` |  566.17 |  3,397 |  619 |  332 |
| `stark_prove_excluding_trace_time_ms` |  4,919 |  29,514 |  5,217 |  3,757 |
| `main_trace_commit_time_ms` |  799 |  4,794 |  951 |  546 |
| `generate_perm_trace_time_ms` |  152.33 |  914 |  189 |  84 |
| `perm_trace_commit_time_ms` |  699.50 |  4,197 |  778 |  497 |
| `quotient_poly_compute_time_ms` |  497.83 |  2,987 |  540 |  323 |
| `quotient_poly_commit_time_ms` |  1,370.67 |  8,224 |  1,448 |  1,181 |
| `pcs_opening_time_ms ` |  1,396 |  8,376 |  1,473 |  1,123 |

| internal.1 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,345.33 |  19,036 |  6,428 |  6,292 |
| `main_cells_used     ` |  66,202,893 |  198,608,679 |  66,386,872 |  65,834,962 |
| `total_cycles        ` |  1,211,595.33 |  3,634,786 |  1,214,154 |  1,206,481 |
| `execute_time_ms     ` |  617.67 |  1,853 |  629 |  597 |
| `trace_gen_time_ms   ` |  585 |  1,755 |  591 |  579 |
| `stark_prove_excluding_trace_time_ms` |  5,142.67 |  15,428 |  5,240 |  5,078 |
| `main_trace_commit_time_ms` |  855 |  2,565 |  865 |  846 |
| `generate_perm_trace_time_ms` |  143.67 |  431 |  192 |  117 |
| `perm_trace_commit_time_ms` |  730 |  2,190 |  748 |  707 |
| `quotient_poly_compute_time_ms` |  538 |  1,614 |  545 |  533 |
| `quotient_poly_commit_time_ms` |  1,434.33 |  4,303 |  1,534 |  1,370 |
| `pcs_opening_time_ms ` |  1,436.33 |  4,309 |  1,454 |  1,410 |

| internal.2 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,441.50 |  10,883 |  6,407 |  4,476 |
| `main_cells_used     ` |  50,222,325 |  100,444,650 |  66,387,493 |  34,057,157 |
| `total_cycles        ` |  910,840 |  1,821,680 |  1,214,223 |  607,457 |
| `execute_time_ms     ` |  471 |  942 |  630 |  312 |
| `trace_gen_time_ms   ` |  461.50 |  923 |  596 |  327 |
| `stark_prove_excluding_trace_time_ms` |  4,509 |  9,018 |  5,181 |  3,837 |
| `main_trace_commit_time_ms` |  706.50 |  1,413 |  835 |  578 |
| `generate_perm_trace_time_ms` |  127.50 |  255 |  184 |  71 |
| `perm_trace_commit_time_ms` |  624.50 |  1,249 |  720 |  529 |
| `quotient_poly_compute_time_ms` |  427 |  854 |  538 |  316 |
| `quotient_poly_commit_time_ms` |  1,311.50 |  2,623 |  1,434 |  1,189 |
| `pcs_opening_time_ms ` |  1,308 |  2,616 |  1,466 |  1,150 |

| internal.3 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,371 |  6,371 |  6,371 |  6,371 |
| `main_cells_used     ` |  65,834,800 |  65,834,800 |  65,834,800 |  65,834,800 |
| `total_cycles        ` |  1,206,463 |  1,206,463 |  1,206,463 |  1,206,463 |
| `execute_time_ms     ` |  593 |  593 |  593 |  593 |
...
| `quotient_poly_commit_time_ms` |  1,410 |  1,410 |  1,410 |  1,410 |
| `pcs_opening_time_ms ` |  1,515 |  1,515 |  1,515 |  1,515 |
...
| `stark_prove_excluding_trace_time_ms` |  3,770 |  3,770 |  3,770 |  3,770 |
...
| `quotient_poly_commit_time_ms` |  1,132 |  1,132 |  1,132 |  1,132 |
| `pcs_opening_time_ms ` |  1,167 |  1,167 |  1,167 |  1,167 |

| root |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  29,109 |  29,109 |  29,109 |  29,109 |
| `main_cells_used     ` |  33,387,721 |  33,387,721 |  33,387,721 |  33,387,721 |
| `total_cycles        ` |  600,093 |  600,093 |  600,093 |  600,093 |
| `execute_time_ms     ` |  288 |  288 |  288 |  288 |
| `trace_gen_time_ms   ` |  330 |  330 |  330 |  330 |
| `stark_prove_excluding_trace_time_ms` |  28,491 |  28,491 |  28,491 |  28,491 |
| `main_trace_commit_time_ms` |  8,087 |  8,087 |  8,087 |  8,087 |
| `generate_perm_trace_time_ms` |  63 |  63 |  63 |  63 |
| `perm_trace_commit_time_ms` |  5,725 |  5,725 |  5,725 |  5,725 |
| `quotient_poly_compute_time_ms` |  614 |  614 |  614 |  614 |
| `quotient_poly_commit_time_ms` |  10,562 |  10,562 |  10,562 |  10,562 |
| `pcs_opening_time_ms ` |  3,435 |  3,435 |  3,435 |  3,435 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  52,595 |  52,595 |  52,595 |  52,595 |
| `main_cells_used     ` |  58,076,647 |  58,076,647 |  58,076,647 |  58,076,647 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  38,455 |  38,455 |  38,455 |  38,455 |

| agg_keygen |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  15,682 |  31,364 |  30,448 |  916 |
...
| `stark_prove_excluding_trace_time_ms` |  15,360 |  30,720 |  29,830 |  890 |
| `main_trace_commit_time_ms` |  4,109 |  8,218 |  8,101 |  117 |
| `generate_perm_trace_time_ms` |  64 |  128 |  72 |  56 |
| `perm_trace_commit_time_ms` |  2,959.50 |  5,919 |  5,794 |  125 |
| `quotient_poly_compute_time_ms` |  334.50 |  669 |  627 |  42 |
| `quotient_poly_commit_time_ms` |  5,910 |  11,820 |  11,696 |  124 |
| `pcs_opening_time_ms ` |  1,978.50 |  3,957 |  3,535 |  422 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 21000000 | 327 | 30,448 | 1,357,955 | 196,035,544 | 29,830 | 627 | 11,696 | 5,794 | 3,535 | 1 | 8,101 | 81,199,789 | 7,911,006 | 18,883 | 72 | 291 | 
| halo2_outer | 21000000 |  | 52,595 |  |  |  |  |  |  |  |  |  | 58,076,647 |  |  |  |  | 
| halo2_wrapper | 21000000 |  | 38,455 |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 21000000 | 0 | 613 | 6,419 | 1,241,363 | 167,723,992 | 5,130 | 539 | 1,448 | 736 | 1,450 | 793 | 69,402,771 | 161 | 676 | 
| internal.0 | 21000000 | 1 | 615 | 6,360 | 1,240,491 | 167,723,992 | 5,058 | 540 | 1,387 | 745 | 1,413 | 845 | 69,358,377 | 125 | 687 | 
| internal.0 | 21000000 | 2 | 607 | 6,521 | 1,241,570 | 167,723,992 | 5,217 | 535 | 1,438 | 778 | 1,473 | 822 | 69,290,626 | 168 | 697 | 
| internal.0 | 21000000 | 3 | 611 | 6,520 | 1,241,527 | 167,723,992 | 5,217 | 522 | 1,386 | 710 | 1,456 | 951 | 69,290,239 | 187 | 692 | 
