...
|:---|---:|---:|
| Total |  1,164.04 |  346.85 |
| reth.prove_e2e.block_21000000 |  680.68 |  92.03 |
| leaf |  183.82 |  22.12 |
| internal.0 |  52.61 |  9.57 |
| internal.1 |  28.33 |  9.45 |
| internal.2 |  14.39 |  9.48 |
| internal.3 |  9.42 |  9.42 |
| root |  74.55 |  74.55 |
| halo2_outer |  80.87 |  80.87 |
| halo2_wrapper |  39.35 |  39.35 |
| agg_keygen |  75.19 |  74.72 |


| reth.prove_e2e.block_21000000 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  61,880.36 |  680,684 |  92,034 |  31,459 |
| `main_cells_used     ` |  1,143,879,100.18 |  12,582,670,102 |  1,923,767,177 |  289,570,010 |
| `total_cycles        ` |  1,959,794 |  1,959,794 |  1,959,794 |  1,959,794 |
| `execute_time_ms     ` |  3,863.27 |  42,496 |  7,454 |  336 |
| `trace_gen_time_ms   ` |  20,441.18 |  224,853 |  29,885 |  11,644 |
| `stark_prove_excluding_trace_time_ms` |  37,575.91 |  413,335 |  58,469 |  8,609 |
| `main_trace_commit_time_ms` |  10,994.36 |  120,938 |  22,445 |  2,638 |
| `generate_perm_trace_time_ms` |  1,676.91 |  18,446 |  2,683 |  250 |
| `perm_trace_commit_time_ms` |  5,948 |  65,428 |  7,583 |  1,190 |
| `quotient_poly_compute_time_ms` |  7,252.18 |  79,774 |  13,422 |  1,356 |
| `quotient_poly_commit_time_ms` |  4,536.82 |  49,905 |  5,707 |  1,192 |
| `pcs_opening_time_ms ` |  7,155 |  78,705 |  10,261 |  1,975 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  16,711.09 |  183,822 |  22,121 |  12,835 |
| `main_cells_used     ` |  187,343,515 |  2,060,778,665 |  267,837,846 |  137,094,049 |
| `total_cycles        ` |  4,163,167.73 |  45,794,845 |  5,810,624 |  3,059,089 |
| `execute_time_ms     ` |  543.18 |  5,975 |  768 |  376 |
| `trace_gen_time_ms   ` |  2,466.27 |  27,129 |  3,576 |  1,823 |
| `stark_prove_excluding_trace_time_ms` |  13,701.64 |  150,718 |  17,777 |  10,632 |
| `main_trace_commit_time_ms` |  2,650.55 |  29,156 |  3,395 |  2,075 |
| `generate_perm_trace_time_ms` |  489.27 |  5,382 |  717 |  334 |
| `perm_trace_commit_time_ms` |  2,416.18 |  26,578 |  3,235 |  1,813 |
| `quotient_poly_compute_time_ms` |  2,041 |  22,451 |  2,951 |  1,411 |
| `quotient_poly_commit_time_ms` |  2,543.55 |  27,979 |  3,251 |  1,990 |
| `pcs_opening_time_ms ` |  3,557.36 |  39,131 |  4,224 |  2,978 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,768.83 |  52,613 |  9,571 |  4,967 |
| `main_cells_used     ` |  130,793,662.83 |  784,761,977 |  142,508,996 |  72,401,749 |
| `total_cycles        ` |  3,576,169.83 |  21,457,019 |  3,901,890 |  1,950,720 |
| `execute_time_ms     ` |  412.33 |  2,474 |  468 |  217 |
| `trace_gen_time_ms   ` |  1,633.50 |  9,801 |  1,816 |  921 |
| `stark_prove_excluding_trace_time_ms` |  6,723 |  40,338 |  7,312 |  3,829 |
| `main_trace_commit_time_ms` |  1,344.17 |  8,065 |  1,468 |  756 |
| `generate_perm_trace_time_ms` |  260.50 |  1,563 |  285 |  145 |
| `perm_trace_commit_time_ms` |  1,166 |  6,996 |  1,281 |  651 |
| `quotient_poly_compute_time_ms` |  1,068 |  6,408 |  1,167 |  603 |
| `quotient_poly_commit_time_ms` |  1,261.33 |  7,568 |  1,374 |  743 |
| `pcs_opening_time_ms ` |  1,619 |  9,714 |  1,776 |  928 |

| internal.1 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  9,443 |  28,329 |  9,450 |  9,430 |
| `main_cells_used     ` |  136,780,971.33 |  410,342,914 |  137,333,765 |  135,676,068 |
| `total_cycles        ` |  3,742,151.67 |  11,226,455 |  3,762,517 |  3,701,497 |
| `execute_time_ms     ` |  427 |  1,281 |  433 |  423 |
| `trace_gen_time_ms   ` |  1,700 |  5,100 |  1,703 |  1,697 |
| `stark_prove_excluding_trace_time_ms` |  7,316 |  21,948 |  7,327 |  7,297 |
| `main_trace_commit_time_ms` |  1,461.33 |  4,384 |  1,463 |  1,459 |
| `generate_perm_trace_time_ms` |  286.67 |  860 |  291 |  284 |
| `perm_trace_commit_time_ms` |  1,274.67 |  3,824 |  1,282 |  1,269 |
| `quotient_poly_compute_time_ms` |  1,162.33 |  3,487 |  1,166 |  1,160 |
| `quotient_poly_commit_time_ms` |  1,372 |  4,116 |  1,379 |  1,359 |
| `pcs_opening_time_ms ` |  1,755.33 |  5,266 |  1,765 |  1,748 |

| internal.2 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,197 |  14,394 |  9,479 |  4,915 |
| `main_cells_used     ` |  103,589,690.50 |  207,179,381 |  137,336,132 |  69,843,249 |
| `total_cycles        ` |  2,822,229 |  5,644,458 |  3,762,780 |  1,881,678 |
| `execute_time_ms     ` |  320 |  640 |  432 |  208 |
| `trace_gen_time_ms   ` |  1,298.50 |  2,597 |  1,735 |  862 |
| `stark_prove_excluding_trace_time_ms` |  5,578.50 |  11,157 |  7,312 |  3,845 |
| `main_trace_commit_time_ms` |  1,109.50 |  2,219 |  1,462 |  757 |
| `generate_perm_trace_time_ms` |  216.50 |  433 |  286 |  147 |
| `perm_trace_commit_time_ms` |  959.50 |  1,919 |  1,266 |  653 |
| `quotient_poly_compute_time_ms` |  886 |  1,772 |  1,159 |  613 |
| `quotient_poly_commit_time_ms` |  1,050.50 |  2,101 |  1,362 |  739 |
| `pcs_opening_time_ms ` |  1,352.50 |  2,705 |  1,774 |  931 |

| internal.3 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  9,423 |  9,423 |  9,423 |  9,423 |
| `main_cells_used     ` |  135,674,619 |  135,674,619 |  135,674,619 |  135,674,619 |
| `total_cycles        ` |  3,701,336 |  3,701,336 |  3,701,336 |  3,701,336 |
| `execute_time_ms     ` |  416 |  416 |  416 |  416 |
| `trace_gen_time_ms   ` |  1,684 |  1,684 |  1,684 |  1,684 |
| `stark_prove_excluding_trace_time_ms` |  7,323 |  7,323 |  7,323 |  7,323 |
| `main_trace_commit_time_ms` |  1,466 |  1,466 |  1,466 |  1,466 |
| `generate_perm_trace_time_ms` |  292 |  292 |  292 |  292 |
| `perm_trace_commit_time_ms` |  1,263 |  1,263 |  1,263 |  1,263 |
| `quotient_poly_compute_time_ms` |  1,155 |  1,155 |  1,155 |  1,155 |
| `quotient_poly_commit_time_ms` |  1,361 |  1,361 |  1,361 |  1,361 |
| `pcs_opening_time_ms ` |  1,782 |  1,782 |  1,782 |  1,782 |

| root |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  74,551 |  74,551 |  74,551 |  74,551 |
| `main_cells_used     ` |  69,863,257 |  69,863,257 |  69,863,257 |  69,863,257 |
| `total_cycles        ` |  1,882,143 |  1,882,143 |  1,882,143 |  1,882,143 |
| `execute_time_ms     ` |  206 |  206 |  206 |  206 |
| `trace_gen_time_ms   ` |  855 |  855 |  855 |  855 |
| `stark_prove_excluding_trace_time_ms` |  73,490 |  73,490 |  73,490 |  73,490 |
| `main_trace_commit_time_ms` |  22,943 |  22,943 |  22,943 |  22,943 |
| `generate_perm_trace_time_ms` |  137 |  137 |  137 |  137 |
| `perm_trace_commit_time_ms` |  16,506 |  16,506 |  16,506 |  16,506 |
| `quotient_poly_compute_time_ms` |  1,348 |  1,348 |  1,348 |  1,348 |
| `quotient_poly_commit_time_ms` |  25,121 |  25,121 |  25,121 |  25,121 |
| `pcs_opening_time_ms ` |  7,431 |  7,431 |  7,431 |  7,431 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  80,873 |  80,873 |  80,873 |  80,873 |
| `main_cells_used     ` |  61,886,027 |  61,886,027 |  61,886,027 |  61,886,027 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  39,347 |  39,347 |  39,347 |  39,347 |

| agg_keygen |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  37,593.50 |  75,187 |  74,716 |  471 |
| `main_cells_used     ` |  84,086,169 |  168,172,338 |  167,244,269 |  928,069 |
| `total_cycles        ` |  4,501,861 |  4,501,861 |  4,501,861 |  4,501,861 |
| `execute_time_ms     ` |  99.50 |  199 |  199 |  0 |
| `trace_gen_time_ms   ` |  439.50 |  879 |  849 |  30 |
| `stark_prove_excluding_trace_time_ms` |  37,054.50 |  74,109 |  73,668 |  441 |
| `main_trace_commit_time_ms` |  11,496.50 |  22,993 |  22,924 |  69 |
| `generate_perm_trace_time_ms` |  72.50 |  145 |  138 |  7 |
| `perm_trace_commit_time_ms` |  8,288 |  16,576 |  16,504 |  72 |
| `quotient_poly_compute_time_ms` |  677 |  1,354 |  1,328 |  26 |
| `quotient_poly_commit_time_ms` |  12,736.50 |  25,473 |  25,399 |  74 |
| `pcs_opening_time_ms ` |  3,779.50 |  7,559 |  7,370 |  189 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 21000000 | 849 | 74,716 | 4,501,861 | 476,922,840 | 73,668 | 1,328 | 25,399 | 16,504 | 7,370 | 1 | 22,924 | 167,244,269 | 5,447,564 | 15,471 | 138 | 199 | 
| halo2_outer | 21000000 |  | 80,873 |  |  |  |  |  |  |  |  |  | 61,886,027 |  |  |  |  | 
| halo2_wrapper | 21000000 |  | 39,347 |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 21000000 | 0 | 1,774 | 9,545 | 3,901,103 | 312,296,408 | 7,303 | 1,159 | 1,365 | 1,267 | 1,760 | 1,465 | 142,460,243 | 284 | 468 | 
| internal.0 | 21000000 | 1 | 1,816 | 9,571 | 3,900,345 | 312,296,408 | 7,308 | 1,167 | 1,362 | 1,267 | 1,758 | 1,468 | 142,433,225 | 282 | 447 | 
| leaf | 21000000 | 5 | 2,903 | 19,605 | 4,843,989 | 719,529,688 | 16,043 | 2,513 | 2,972 | 2,847 | 4,010 | 3,094 | 217,781,576 | 604 | 659 | 
| leaf | 21000000 | 6 | 2,922 | 19,621 | 4,846,476 | 719,529,688 | 16,040 | 2,493 | 2,973 | 2,857 | 4,039 | 3,072 | 217,882,916 | 603 | 659 | 
| leaf | 21000000 | 7 | 2,752 | 19,119 | 4,760,781 | 706,422,488 | 15,718 | 2,482 | 2,876 | 2,806 | 3,943 | 3,013 | 215,066,990 | 594 | 649 | 
| leaf | 21000000 | 8 | 2,785 | 19,120 | 4,803,866 | 706,422,488 | 15,688 | 2,440 | 2,864 | 2,840 | 3,938 | 3,010 | 216,502,720 | 591 | 647 | 
| leaf | 21000000 | 9 | 1,989 | 13,139 | 3,467,621 | 423,438,040 | 10,717 | 1,421 | 2,025 | 1,827 | 2,978 | 2,125 | 152,773,013 | 338 | 433 | 
| root | 21000000 | 0 | 855 | 74,551 | 1,882,143 | 136,618,392 | 73,490 | 1,348 | 25,121 | 16,506 | 7,431 | 22,943 | 69,863,257 | 137 | 206 | 

| group | block_number | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 21000000 | 0 | 30 | 471 |  | 7,747,673 | 441 | 26 | 74 | 72 | 189 | 69 | 928,069 | 7 | 0 | 
| reth.prove_e2e.block_21000000 | 21000000 | 0 | 13,431 | 52,731 |  | 1,976,080,643 | 36,521 | 5,896 | 5,160 | 6,360 | 7,520 | 9,949 | 988,874,955 | 1,616 | 2,779 | 
| reth.prove_e2e.block_21000000 | 21000000 | 1 | 14,217 | 51,794 |  | 1,976,246,919 | 33,720 | 5,897 | 4,583 | 5,662 | 7,057 | 9,029 | 985,973,086 | 1,483 | 3,857 | 
| reth.prove_e2e.block_21000000 | 21000000 | 10 | 22,514 | 31,459 | 1,959,794 | 499,272,480 | 8,609 | 1,356 | 1,192 | 1,190 | 1,975 | 2,638 | 289,570,010 | 250 | 336 | 
| reth.prove_e2e.block_21000000 | 21000000 | 2 | 15,293 | 53,182 |  | 1,976,246,919 | 34,072 | 5,899 | 4,643 | 5,744 | 7,156 | 9,005 | 986,856,787 | 1,616 | 3,817 | 
| reth.prove_e2e.block_21000000 | 21000000 | 3 | 11,644 | 53,445 |  | 2,814,652,440 | 40,698 | 10,220 | 2,631 | 4,827 | 4,542 | 17,153 | 1,427,796,972 | 1,316 | 1,103 | 
| reth.prove_e2e.block_21000000 | 21000000 | 4 | 24,158 | 75,364 |  | 2,637,214,296 | 43,752 | 8,933 | 5,308 | 7,140 | 8,170 | 12,161 | 1,355,763,285 | 2,026 | 7,454 | 
| reth.prove_e2e.block_21000000 | 21000000 | 5 | 20,323 | 64,386 |  | 2,094,122,136 | 39,875 | 6,794 | 5,340 | 6,438 | 10,261 | 9,223 | 1,089,805,004 | 1,802 | 4,188 | 
| reth.prove_e2e.block_21000000 | 21000000 | 6 | 23,426 | 70,147 |  | 2,238,650,648 | 41,576 | 7,267 | 5,707 | 7,551 | 8,202 | 10,150 | 1,149,257,839 | 2,683 | 5,145 | 
| reth.prove_e2e.block_21000000 | 21000000 | 7 | 23,695 | 65,947 |  | 2,077,993,816 | 37,202 | 6,732 | 5,385 | 6,399 | 7,764 | 9,101 | 1,108,265,611 | 1,806 | 5,050 | 
| reth.prove_e2e.block_21000000 | 21000000 | 8 | 26,267 | 70,195 |  | 2,246,402,456 | 38,841 | 7,358 | 5,254 | 6,534 | 7,851 | 10,084 | 1,276,739,376 | 1,747 | 5,087 | 
| reth.prove_e2e.block_21000000 | 21000000 | 9 | 29,885 | 92,034 |  | 4,157,766,168 | 58,469 | 13,422 | 4,702 | 7,583 | 8,207 | 22,445 | 1,923,767,177 | 2,101 | 3,680 | 
...
[Benchmark Workflow](https://github.com/axiom-crypto/openvm-reth-benchmark/actions/runs/13124536169)
