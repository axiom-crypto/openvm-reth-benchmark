...
|:---|---:|---:|
| Total |  609.38 |  199.95 |
| reth.prove_evm.block_21000000 |  314.73 |  37.11 |
| leaf |  105.64 |  11.48 |
| internal.0 |  45.74 |  12.22 |
| internal.1 |  12.50 |  8.37 |
| internal.2 |  6.14 |  6.14 |
| root |  30.88 |  30.88 |
| halo2_outer |  55.17 |  55.17 |
| halo2_wrapper |  38.60 |  38.60 |
| agg_keygen |  31.92 |  31.15 |


| reth.prove_evm.block_21000000 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  28,611.45 |  314,726 |  37,107 |  15,606 |
| `main_cells_used     ` |  1,152,459,661 |  12,677,056,271 |  1,513,540,860 |  734,667,536 |
| `total_cycles        ` |  18,582,180.27 |  204,403,983 |  24,897,409 |  4,949,486 |
| `execute_time_ms     ` |  2,892.82 |  31,821 |  6,195 |  731 |
| `trace_gen_time_ms   ` |  9,122.91 |  100,352 |  11,527 |  4,694 |
| `stark_prove_excluding_trace_time_ms` |  16,595.73 |  182,553 |  20,288 |  9,884 |
| `main_trace_commit_time_ms` |  4,100.82 |  45,109 |  6,890 |  2,882 |
| `generate_perm_trace_time_ms` |  1,043.36 |  11,477 |  1,328 |  399 |
| `perm_trace_commit_time_ms` |  3,144.27 |  34,587 |  3,924 |  1,470 |
| `quotient_poly_compute_time_ms` |  3,110.64 |  34,217 |  5,797 |  2,234 |
| `quotient_poly_commit_time_ms` |  1,293.55 |  14,229 |  1,657 |  734 |
| `pcs_opening_time_ms ` |  3,890 |  42,790 |  4,722 |  2,154 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  9,603.73 |  105,641 |  11,478 |  7,019 |
| `main_cells_used     ` |  222,475,462.45 |  2,447,230,087 |  278,431,538 |  155,251,585 |
| `total_cycles        ` |  2,809,153.45 |  30,900,688 |  3,459,009 |  2,024,314 |
| `execute_time_ms     ` |  1,243.82 |  13,682 |  1,430 |  1,021 |
| `trace_gen_time_ms   ` |  1,866.27 |  20,529 |  2,311 |  1,333 |
| `stark_prove_excluding_trace_time_ms` |  6,493.64 |  71,430 |  7,765 |  4,663 |
| `main_trace_commit_time_ms` |  1,132 |  12,452 |  1,360 |  753 |
| `generate_perm_trace_time_ms` |  398.45 |  4,383 |  521 |  254 |
| `perm_trace_commit_time_ms` |  1,491 |  16,401 |  1,855 |  1,020 |
| `quotient_poly_compute_time_ms` |  893.27 |  9,826 |  1,087 |  610 |
| `quotient_poly_commit_time_ms` |  723.09 |  7,954 |  849 |  586 |
| `pcs_opening_time_ms ` |  1,850.36 |  20,354 |  2,201 |  1,418 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,435 |  45,740 |  12,218 |  9,353 |
| `main_cells_used     ` |  194,827,778 |  779,311,112 |  214,267,868 |  140,443,346 |
| `total_cycles        ` |  3,276,494.25 |  13,105,977 |  3,596,245 |  2,365,526 |
| `execute_time_ms     ` |  2,014.25 |  8,057 |  2,289 |  1,391 |
| `trace_gen_time_ms   ` |  1,564.25 |  6,257 |  1,719 |  1,143 |
| `stark_prove_excluding_trace_time_ms` |  7,856.50 |  31,426 |  8,313 |  6,819 |
| `main_trace_commit_time_ms` |  1,543 |  6,172 |  1,637 |  1,270 |
| `generate_perm_trace_time_ms` |  259.50 |  1,038 |  284 |  214 |
| `perm_trace_commit_time_ms` |  1,213.75 |  4,855 |  1,279 |  1,032 |
| `quotient_poly_compute_time_ms` |  1,209 |  4,836 |  1,283 |  1,000 |
| `quotient_poly_commit_time_ms` |  1,610.75 |  6,443 |  1,786 |  1,433 |
| `pcs_opening_time_ms ` |  2,014.75 |  8,059 |  2,078 |  1,865 |

| internal.1 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,249 |  12,498 |  8,368 |  4,130 |
| `main_cells_used     ` |  75,079,280 |  150,158,560 |  111,971,605 |  38,186,955 |
| `total_cycles        ` |  1,532,535.50 |  3,065,071 |  2,298,921 |  766,150 |
| `execute_time_ms     ` |  650.50 |  1,301 |  972 |  329 |
| `trace_gen_time_ms   ` |  675 |  1,350 |  986 |  364 |
| `stark_prove_excluding_trace_time_ms` |  4,923.50 |  9,847 |  6,410 |  3,437 |
| `main_trace_commit_time_ms` |  844.50 |  1,689 |  1,188 |  501 |
| `generate_perm_trace_time_ms` |  161.50 |  323 |  263 |  60 |
| `perm_trace_commit_time_ms` |  666.50 |  1,333 |  856 |  477 |
| `quotient_poly_compute_time_ms` |  610.50 |  1,221 |  860 |  361 |
| `quotient_poly_commit_time_ms` |  1,216.50 |  2,433 |  1,419 |  1,014 |
| `pcs_opening_time_ms ` |  1,416.50 |  2,833 |  1,817 |  1,016 |
...
| `stark_prove_excluding_trace_time_ms` |  4,866 |  4,866 |  4,866 |  4,866 |
...
| `main_cells_used     ` |  37,522,995 |  37,522,995 |  37,522,995 |  37,522,995 |
| `total_cycles        ` |  759,282 |  759,282 |  759,282 |  759,282 |
| `execute_time_ms     ` |  308 |  308 |  308 |  308 |
| `trace_gen_time_ms   ` |  359 |  359 |  359 |  359 |
| `stark_prove_excluding_trace_time_ms` |  30,210 |  30,210 |  30,210 |  30,210 |
| `main_trace_commit_time_ms` |  8,900 |  8,900 |  8,900 |  8,900 |
| `generate_perm_trace_time_ms` |  66 |  66 |  66 |  66 |
| `perm_trace_commit_time_ms` |  5,550 |  5,550 |  5,550 |  5,550 |
| `quotient_poly_compute_time_ms` |  775 |  775 |  775 |  775 |
| `quotient_poly_commit_time_ms` |  11,424 |  11,424 |  11,424 |  11,424 |
| `pcs_opening_time_ms ` |  3,487 |  3,487 |  3,487 |  3,487 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  55,166 |  55,166 |  55,166 |  55,166 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  15,961 |  31,922 |  31,147 |  775 |
| `main_cells_used     ` |  43,446,580.50 |  86,893,161 |  86,882,605 |  10,556 |
| `total_cycles        ` |  1,636,805 |  1,636,805 |  1,636,805 |  1,636,805 |
| `execute_time_ms     ` |  157.50 |  315 |  315 |  0 |
| `trace_gen_time_ms   ` |  192 |  384 |  359 |  25 |
| `stark_prove_excluding_trace_time_ms` |  15,611.50 |  31,223 |  30,473 |  750 |
| `main_trace_commit_time_ms` |  4,473 |  8,946 |  8,849 |  97 |
| `generate_perm_trace_time_ms` |  58.50 |  117 |  99 |  18 |
| `perm_trace_commit_time_ms` |  2,827.50 |  5,655 |  5,571 |  84 |
| `quotient_poly_compute_time_ms` |  415.50 |  831 |  799 |  32 |
| `quotient_poly_commit_time_ms` |  5,806 |  11,612 |  11,505 |  107 |
| `pcs_opening_time_ms ` |  2,026 |  4,052 |  3,644 |  408 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 21000000 | 359 | 31,147 | 1,636,805 | 270,872,042 | 30,473 | 799 | 11,505 | 5,571 | 3,644 | 1 | 8,849 | 86,882,605 | 8,037,489 | 18,996 | 99 | 315 | 
| halo2_outer | 21000000 |  | 55,166 |  |  |  |  |  |  |  |  |  | 62,800,919 |  |  |  |  | 
| halo2_wrapper | 21000000 |  | 38,598 |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 21000000 | 0 | 1,689 | 12,011 | 3,564,026 | 472,992,226 | 8,131 | 1,280 | 1,623 | 1,277 | 2,046 | 1,634 | 211,573,103 | 266 | 2,191 | 
| internal.0 | 21000000 | 1 | 1,719 | 12,218 | 3,580,180 | 472,992,226 | 8,313 | 1,273 | 1,786 | 1,267 | 2,070 | 1,637 | 213,026,795 | 274 | 2,186 | 
| internal.0 | 21000000 | 2 | 1,706 | 12,158 | 3,596,245 | 472,992,226 | 8,163 | 1,283 | 1,601 | 1,279 | 2,078 | 1,631 | 214,267,868 | 284 | 2,289 | 
| internal.0 | 21000000 | 3 | 1,143 | 9,353 | 2,365,526 | 346,728,930 | 6,819 | 1,000 | 1,433 | 1,032 | 1,865 | 1,270 | 140,443,346 | 214 | 1,391 | 
| internal.1 | 21000000 | 4 | 986 | 8,368 | 2,298,921 | 300,984,802 | 6,410 | 860 | 1,419 | 856 | 1,817 | 1,188 | 111,971,605 | 263 | 972 | 
| internal.1 | 21000000 | 5 | 364 | 4,130 | 766,150 | 95,656,418 | 3,437 | 361 | 1,014 | 477 | 1,016 | 501 | 38,186,955 | 60 | 329 | 
| internal.2 | 21000000 | 6 | 655 | 6,139 | 1,516,146 | 186,591,714 | 4,866 | 594 | 1,185 | 708 | 1,424 | 837 | 73,850,070 | 112 | 618 | 
| leaf | 21000000 | 0 | 2,054 | 10,724 | 3,028,841 | 1,037,143,530 | 7,351 | 1,019 | 764 | 1,769 | 2,068 | 1,269 | 247,923,952 | 455 | 1,319 | 
| leaf | 21000000 | 1 | 1,368 | 7,405 | 2,040,228 | 664,751,594 | 4,981 | 666 | 594 | 1,086 | 1,490 | 867 | 156,790,070 | 272 | 1,056 | 
| leaf | 21000000 | 10 | 1,503 | 7,899 | 2,256,821 | 732,909,034 | 5,375 | 725 | 630 | 1,159 | 1,541 | 964 | 168,403,012 | 350 | 1,021 | 
| leaf | 21000000 | 2 | 1,364 | 7,451 | 2,040,131 | 664,751,594 | 5,030 | 660 | 586 | 1,155 | 1,481 | 876 | 156,789,919 | 267 | 1,057 | 
| leaf | 21000000 | 3 | 1,333 | 7,019 | 2,024,314 | 571,690,474 | 4,663 | 610 | 604 | 1,020 | 1,418 | 753 | 155,251,585 | 254 | 1,023 | 
| leaf | 21000000 | 4 | 2,311 | 11,478 | 3,459,009 | 1,100,058,090 | 7,741 | 1,086 | 845 | 1,805 | 2,148 | 1,351 | 278,250,734 | 501 | 1,426 | 
| leaf | 21000000 | 5 | 2,269 | 11,447 | 3,457,877 | 1,100,058,090 | 7,765 | 1,082 | 819 | 1,805 | 2,179 | 1,354 | 278,335,294 | 521 | 1,413 | 
