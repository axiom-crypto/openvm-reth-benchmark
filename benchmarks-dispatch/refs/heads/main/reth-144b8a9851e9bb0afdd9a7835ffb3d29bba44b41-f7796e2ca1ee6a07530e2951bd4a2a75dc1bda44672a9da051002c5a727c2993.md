...
|:---|---:|---:|
| Total |  800.81 |  227.54 |
| reth.prove_e2e.block_21000000 |  484.99 |  63.07 |
| leaf |  119.36 |  14.45 |
| internal.0 |  36.15 |  6.53 |
| internal.1 |  18.81 |  6.31 |
| internal.2 |  10.57 |  6.25 |
| internal.3 |  6.19 |  6.19 |
| internal.4 |  4.35 |  4.35 |
| root |  28.95 |  28.95 |
| halo2_outer |  53.19 |  53.19 |
| halo2_wrapper |  38.26 |  38.26 |
| agg_keygen |  30.42 |  29.56 |


| reth.prove_e2e.block_21000000 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,090 |  484,990 |  63,070 |  12,580 |
| `main_cells_used     ` |  1,143,784,968.36 |  12,581,634,652 |  1,924,130,532 |  289,519,126 |
| `total_cycles        ` |  1,959,981 |  1,959,981 |  1,959,981 |  1,959,981 |
| `execute_time_ms     ` |  3,033.64 |  33,370 |  6,365 |  278 |
| `trace_gen_time_ms   ` |  9,277.64 |  102,054 |  11,712 |  3,158 |
| `stark_prove_excluding_trace_time_ms` |  31,778.73 |  349,566 |  50,380 |  9,144 |
| `main_trace_commit_time_ms` |  8,072.64 |  88,799 |  16,912 |  2,167 |
| `generate_perm_trace_time_ms` |  1,015.09 |  11,166 |  1,285 |  234 |
| `perm_trace_commit_time_ms` |  4,654.36 |  51,198 |  5,914 |  1,220 |
| `quotient_poly_compute_time_ms` |  6,177 |  67,947 |  13,439 |  1,224 |
| `quotient_poly_commit_time_ms` |  5,025.73 |  55,283 |  6,277 |  1,908 |
| `pcs_opening_time_ms ` |  6,821.18 |  75,033 |  8,175 |  2,381 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,850.73 |  119,358 |  14,451 |  9,379 |
| `main_cells_used     ` |  115,677,761 |  1,272,455,371 |  171,123,390 |  81,956,371 |
| `total_cycles        ` |  1,528,632.36 |  16,814,956 |  2,247,087 |  1,036,915 |
| `execute_time_ms     ` |  569.18 |  6,261 |  721 |  451 |
| `trace_gen_time_ms   ` |  1,085.36 |  11,939 |  1,542 |  805 |
| `stark_prove_excluding_trace_time_ms` |  9,196.18 |  101,158 |  12,188 |  8,088 |
| `main_trace_commit_time_ms` |  1,493.73 |  16,431 |  2,019 |  1,256 |
| `generate_perm_trace_time_ms` |  247.36 |  2,721 |  337 |  172 |
| `perm_trace_commit_time_ms` |  1,385.18 |  15,237 |  2,017 |  1,127 |
| `quotient_poly_compute_time_ms` |  1,007.27 |  11,080 |  1,604 |  784 |
| `quotient_poly_commit_time_ms` |  2,134.45 |  23,479 |  2,730 |  1,933 |
| `pcs_opening_time_ms ` |  2,924.18 |  32,166 |  3,476 |  2,705 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,025 |  36,150 |  6,526 |  4,371 |
| `main_cells_used     ` |  63,700,851.50 |  382,205,109 |  69,403,896 |  35,532,729 |
| `total_cycles        ` |  1,137,846.83 |  6,827,081 |  1,241,638 |  620,631 |
| `execute_time_ms     ` |  635 |  3,810 |  699 |  350 |
| `trace_gen_time_ms   ` |  563 |  3,378 |  629 |  334 |
| `stark_prove_excluding_trace_time_ms` |  4,827 |  28,962 |  5,205 |  3,687 |
| `main_trace_commit_time_ms` |  769.83 |  4,619 |  835 |  521 |
| `generate_perm_trace_time_ms` |  127.50 |  765 |  170 |  112 |
| `perm_trace_commit_time_ms` |  687 |  4,122 |  752 |  509 |
| `quotient_poly_compute_time_ms` |  499.50 |  2,997 |  541 |  313 |
| `quotient_poly_commit_time_ms` |  1,346.83 |  8,081 |  1,477 |  1,132 |
| `pcs_opening_time_ms ` |  1,392.67 |  8,356 |  1,509 |  1,086 |

| internal.1 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,269 |  18,807 |  6,313 |  6,229 |
| `main_cells_used     ` |  66,202,635 |  198,607,905 |  66,386,899 |  65,834,413 |
| `total_cycles        ` |  1,211,566.67 |  3,634,700 |  1,214,157 |  1,206,420 |
| `execute_time_ms     ` |  619.33 |  1,858 |  624 |  611 |
| `trace_gen_time_ms   ` |  602.33 |  1,807 |  608 |  596 |
| `stark_prove_excluding_trace_time_ms` |  5,047.33 |  15,142 |  5,099 |  5,010 |
| `main_trace_commit_time_ms` |  873 |  2,619 |  944 |  819 |
| `generate_perm_trace_time_ms` |  145 |  435 |  181 |  126 |
| `perm_trace_commit_time_ms` |  731 |  2,193 |  760 |  700 |
| `quotient_poly_compute_time_ms` |  534 |  1,602 |  540 |  529 |
| `quotient_poly_commit_time_ms` |  1,356.33 |  4,069 |  1,390 |  1,334 |
| `pcs_opening_time_ms ` |  1,405 |  4,215 |  1,443 |  1,375 |

| internal.2 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,286.50 |  10,573 |  6,245 |  4,328 |
| `main_cells_used     ` |  50,187,156.50 |  100,374,313 |  66,386,512 |  33,987,801 |
| `total_cycles        ` |  910,748 |  1,821,496 |  1,214,114 |  607,382 |
| `execute_time_ms     ` |  464.50 |  929 |  624 |  305 |
| `trace_gen_time_ms   ` |  458.50 |  917 |  596 |  321 |
| `stark_prove_excluding_trace_time_ms` |  4,363.50 |  8,727 |  5,025 |  3,702 |
| `main_trace_commit_time_ms` |  690 |  1,380 |  834 |  546 |
| `generate_perm_trace_time_ms` |  105.50 |  211 |  144 |  67 |
| `perm_trace_commit_time_ms` |  608.50 |  1,217 |  700 |  517 |
| `quotient_poly_compute_time_ms` |  427 |  854 |  529 |  325 |
| `quotient_poly_commit_time_ms` |  1,249.50 |  2,499 |  1,385 |  1,114 |
| `pcs_opening_time_ms ` |  1,279.50 |  2,559 |  1,430 |  1,129 |
...
| `execute_time_ms     ` |  604 |  604 |  604 |  604 |
...
| `quotient_poly_commit_time_ms` |  1,383 |  1,383 |  1,383 |  1,383 |
...
| `main_cells_used     ` |  33,987,873 |  33,987,873 |  33,987,873 |  33,987,873 |
...
| `quotient_poly_commit_time_ms` |  1,097 |  1,097 |  1,097 |  1,097 |
| `pcs_opening_time_ms ` |  1,161 |  1,161 |  1,161 |  1,161 |

| root |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  28,945 |  28,945 |  28,945 |  28,945 |
...
| `main_trace_commit_time_ms` |  8,015 |  8,015 |  8,015 |  8,015 |
...
| `quotient_poly_commit_time_ms` |  10,431 |  10,431 |  10,431 |  10,431 |
| `pcs_opening_time_ms ` |  3,470 |  3,470 |  3,470 |  3,470 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  53,190 |  53,190 |  53,190 |  53,190 |
| `main_cells_used     ` |  58,076,647 |  58,076,647 |  58,076,647 |  58,076,647 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  38,261 |  38,261 |  38,261 |  38,261 |

| agg_keygen |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  15,209 |  30,418 |  29,562 |  856 |
...
| `trace_gen_time_ms   ` |  174.50 |  349 |  325 |  24 |
| `stark_prove_excluding_trace_time_ms` |  14,887 |  29,774 |  28,942 |  832 |
| `main_trace_commit_time_ms` |  4,093.50 |  8,187 |  8,067 |  120 |
| `generate_perm_trace_time_ms` |  69 |  138 |  104 |  34 |
| `perm_trace_commit_time_ms` |  3,005.50 |  6,011 |  5,911 |  100 |
| `quotient_poly_compute_time_ms` |  327.50 |  655 |  617 |  38 |
| `quotient_poly_commit_time_ms` |  5,435.50 |  10,871 |  10,746 |  125 |
| `pcs_opening_time_ms ` |  1,952.50 |  3,905 |  3,493 |  412 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 21000000 | 325 |