...
|:---|---:|---:|
| Total |  552.36 |  170.59 |
| reth.prove_e2e.block_21000000 |  291.89 |  35.67 |
| leaf |  91.01 |  10.12 |
| internal.0 |  41.34 |  7.73 |
...
| `total_proof_time_ms ` |  26,535.18 |  291,887 |  35,671 |  7,242 |
| `main_cells_used     ` |  1,152,993,009.18 |  12,682,923,101 |  1,935,243,758 |  290,200,134 |
| `total_cycles        ` |  18,515,897.55 |  203,674,873 |  24,830,648 |  1,960,905 |
| `execute_time_ms     ` |  2,833.09 |  31,164 |  5,992 |  278 |
| `trace_gen_time_ms   ` |  8,541.36 |  93,955 |  10,702 |  3,123 |
| `stark_prove_excluding_trace_time_ms` |  15,160.73 |  166,768 |  24,312 |  3,841 |
| `main_trace_commit_time_ms` |  3,511.45 |  38,626 |  7,507 |  854 |
| `generate_perm_trace_time_ms` |  807.91 |  8,887 |  1,094 |  130 |
| `perm_trace_commit_time_ms` |  3,790.36 |  41,694 |  5,152 |  718 |
| `quotient_poly_compute_time_ms` |  2,795.73 |  30,753 |  5,819 |  641 |
| `quotient_poly_commit_time_ms` |  1,216.18 |  13,378 |  1,529 |  416 |
| `pcs_opening_time_ms ` |  3,026.09 |  33,287 |  3,599 |  1,074 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,273.73 |  91,011 |  10,115 |  5,828 |
| `main_cells_used     ` |  222,808,461 |  2,450,893,071 |  279,569,452 |  156,474,601 |
| `total_cycles        ` |  2,794,724.18 |  30,741,966 |  3,458,679 |  2,024,034 |
| `execute_time_ms     ` |  934.73 |  10,282 |  1,114 |  718 |
| `trace_gen_time_ms   ` |  1,691.55 |  18,607 |  2,116 |  1,231 |
| `stark_prove_excluding_trace_time_ms` |  5,647.45 |  62,122 |  6,903 |  3,879 |
| `main_trace_commit_time_ms` |  864.09 |  9,505 |  1,058 |  554 |
| `generate_perm_trace_time_ms` |  323.73 |  3,561 |  406 |  210 |
| `perm_trace_commit_time_ms` |  1,660.27 |  18,263 |  2,074 |  1,083 |
| `quotient_poly_compute_time_ms` |  825.09 |  9,076 |  1,015 |  565 |
| `quotient_poly_commit_time_ms` |  617.64 |  6,794 |  749 |  462 |
| `pcs_opening_time_ms ` |  1,351.73 |  14,869 |  1,619 |  995 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,889.67 |  41,338 |  7,726 |  4,224 |
| `main_cells_used     ` |  130,364,415.17 |  782,186,491 |  143,303,001 |  71,109,977 |
| `total_cycles        ` |  2,182,423.33 |  13,094,540 |  2,395,500 |  1,181,916 |
| `execute_time_ms     ` |  855 |  5,130 |  957 |  453 |
| `trace_gen_time_ms   ` |  977.17 |  5,863 |  1,091 |  546 |
| `stark_prove_excluding_trace_time_ms` |  5,057.50 |  30,345 |  5,678 |  3,225 |
| `main_trace_commit_time_ms` |  937.17 |  5,623 |  1,126 |  541 |
| `generate_perm_trace_time_ms` |  174.50 |  1,047 |  198 |  100 |
| `perm_trace_commit_time_ms` |  846.50 |  5,079 |  970 |  507 |
| `quotient_poly_compute_time_ms` |  834.50 |  5,007 |  959 |  506 |
| `quotient_poly_commit_time_ms` |  1,005.83 |  6,035 |  1,106 |  696 |
| `pcs_opening_time_ms ` |  1,254.50 |  7,527 |  1,365 |  871 |

| internal.1 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,276 |  12,828 |  4,332 |  4,242 |
| `main_cells_used     ` |  75,026,678 |  225,080,034 |  75,224,713 |  74,657,278 |
| `total_cycles        ` |  1,527,703.33 |  4,583,110 |  1,530,422 |  1,522,485 |
| `execute_time_ms     ` |  431.67 |  1,295 |  437 |  425 |
| `trace_gen_time_ms   ` |  609.33 |  1,828 |  614 |  606 |
| `stark_prove_excluding_trace_time_ms` |  3,235 |  9,705 |  3,293 |  3,203 |
| `main_trace_commit_time_ms` |  535 |  1,605 |  539 |  532 |
| `generate_perm_trace_time_ms` |  99.67 |  299 |  105 |  94 |
| `perm_trace_commit_time_ms` |  491.67 |  1,475 |  495 |  489 |
| `quotient_poly_compute_time_ms` |  491.67 |  1,475 |  495 |  489 |
| `quotient_poly_commit_time_ms` |  728.33 |  2,185 |  755 |  700 |
| `pcs_opening_time_ms ` |  884.33 |  2,653 |  915 |  862 |

| internal.2 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,392.50 |  6,785 |  4,239 |  2,546 |
| `main_cells_used     ` |  55,772,773 |  111,545,546 |  73,816,550 |  37,728,996 |
| `total_cycles        ` |  1,136,446.50 |  2,272,893 |  1,514,979 |  757,914 |
| `execute_time_ms     ` |  315 |  630 |  419 |  211 |
| `trace_gen_time_ms   ` |  466 |  932 |  610 |  322 |
| `stark_prove_excluding_trace_time_ms` |  2,611.50 |  5,223 |  3,210 |  2,013 |
...
| `quotient_poly_commit_time_ms` |  602.50 |  1,205 |  726 |  479 |
...
| `main_cells_used     ` |  73,292,685 |  73,292,685 |  73,292,685 |  73,292,685 |
| `total_cycles        ` |  1,507,318 |  1,507,318 |  1,507,318 |  1,507,318 |
...
| `quotient_poly_commit_time_ms` |  7,935 |  7,935 |  7,935 |  7,935 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,641 |  23,282 |  22,843 |  439 |
| `main_cells_used     ` |  44,005,575.50 |  88,011,151 |  87,083,080 |  928,071 |
| `total_cycles        ` |  1,636,450 |  1,636,450 |  1,636,450 |  1,636,450 |
| `execute_time_ms     ` |  104 |  208 |  208 |  0 |
| `trace_gen_time_ms   ` |  176.50 |  353 |  325 |  28 |
| `stark_prove_excluding_trace_time_ms` |  11,360.50 |  22,721 |  22,310 |  411 |
...
| `pcs_opening_time_ms ` |  1,310 |  2,620 |  2,419 |  201 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 21000000 | 325 | 22,843 | 1,636,450 | 269,692,394 | 22,310 | 560 | 8,117 | 4,261 | 2,419 | 1 | 6,895 | 87,083,080 | 8,037,489 | 17,787 | 52 | 208 | 
| halo2_outer | 21000000 |  | 46,422 |  |  |  |  |  |  |  |  |  | 61,870,615 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 21000000 | 0 | 1,081 | 7,249 | 2,379,168 | 345,876,962 | 5,244 | 862 | 1,051 | 876 | 1,322 | 949 | 142,041,727 | 179 | 924 | 
| internal.0 | 21000000 | 1 | 1,031 | 7,203 | 2,363,022 | 345,418,210 | 5,262 | 859 | 1,094 | 885 | 1,303 | 940 | 140,382,240 | 175 | 910 | 
