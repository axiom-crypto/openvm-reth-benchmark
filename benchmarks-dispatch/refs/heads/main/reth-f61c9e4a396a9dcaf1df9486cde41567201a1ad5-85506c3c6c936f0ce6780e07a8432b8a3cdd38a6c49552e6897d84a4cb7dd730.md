...
|:---|---:|---:|
| Total |  608.82 |  199.34 |
| reth.prove_evm.block_21000000 |  314.16 |  36.64 |
| leaf |  105.72 |  11.57 |
| internal.0 |  45.86 |  12.16 |
| internal.1 |  12.38 |  8.28 |
| internal.2 |  6.05 |  6.05 |
| root |  30.75 |  30.75 |
| halo2_outer |  55.21 |  55.21 |
| halo2_wrapper |  38.68 |  38.68 |
| agg_keygen |  31.57 |  30.80 |


| reth.prove_evm.block_21000000 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  28,560.18 |  314,162 |  36,643 |  15,524 |
| `main_cells_used     ` |  1,153,096,896.82 |  12,684,065,865 |  1,513,541,770 |  734,518,832 |
| `total_cycles        ` |  18,582,180.27 |  204,403,983 |  24,897,409 |  4,949,486 |
| `execute_time_ms     ` |  2,909 |  31,999 |  6,206 |  734 |
| `trace_gen_time_ms   ` |  9,131.55 |  100,447 |  11,458 |  4,818 |
| `stark_prove_excluding_trace_time_ms` |  16,519.64 |  181,716 |  19,959 |  9,799 |
| `main_trace_commit_time_ms` |  4,072.45 |  44,797 |  6,982 |  2,881 |
| `generate_perm_trace_time_ms` |  1,006.64 |  11,073 |  1,223 |  416 |
| `perm_trace_commit_time_ms` |  3,141.64 |  34,558 |  3,839 |  1,454 |
| `quotient_poly_compute_time_ms` |  3,089.64 |  33,986 |  5,749 |  2,223 |
| `quotient_poly_commit_time_ms` |  1,280.27 |  14,083 |  1,572 |  700 |
| `pcs_opening_time_ms ` |  3,915.64 |  43,072 |  4,726 |  2,116 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  9,611.27 |  105,724 |  11,571 |  7,030 |
| `main_cells_used     ` |  222,475,488.64 |  2,447,230,375 |  278,432,234 |  155,250,553 |
| `total_cycles        ` |  2,809,155.64 |  30,900,712 |  3,459,113 |  2,024,228 |
| `execute_time_ms     ` |  1,254.64 |  13,801 |  1,459 |  1,016 |
| `trace_gen_time_ms   ` |  1,872.82 |  20,601 |  2,325 |  1,352 |
| `stark_prove_excluding_trace_time_ms` |  6,483.82 |  71,322 |  7,818 |  4,650 |
| `main_trace_commit_time_ms` |  1,123.73 |  12,361 |  1,366 |  728 |
| `generate_perm_trace_time_ms` |  393.45 |  4,328 |  488 |  249 |
| `perm_trace_commit_time_ms` |  1,464.09 |  16,105 |  1,806 |  972 |
| `quotient_poly_compute_time_ms` |  894.73 |  9,842 |  1,098 |  602 |
| `quotient_poly_commit_time_ms` |  721.55 |  7,937 |  853 |  580 |
| `pcs_opening_time_ms ` |  1,880.73 |  20,688 |  2,223 |  1,501 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,466 |  45,864 |  12,165 |  9,647 |
| `main_cells_used     ` |  194,828,987 |  779,315,948 |  214,270,532 |  140,444,150 |
| `total_cycles        ` |  3,276,595 |  13,106,380 |  3,596,467 |  2,365,593 |
| `execute_time_ms     ` |  2,007.50 |  8,030 |  2,262 |  1,407 |
| `trace_gen_time_ms   ` |  1,568.25 |  6,273 |  1,719 |  1,140 |
| `stark_prove_excluding_trace_time_ms` |  7,890.25 |  31,561 |  8,184 |  7,100 |
| `main_trace_commit_time_ms` |  1,546.25 |  6,185 |  1,640 |  1,299 |
| `generate_perm_trace_time_ms` |  286.25 |  1,145 |  317 |  259 |
| `perm_trace_commit_time_ms` |  1,175.25 |  4,701 |  1,206 |  1,085 |
| `quotient_poly_compute_time_ms` |  1,214 |  4,856 |  1,296 |  996 |
| `quotient_poly_commit_time_ms` |  1,599.50 |  6,398 |  1,680 |  1,451 |
| `pcs_opening_time_ms ` |  2,063.25 |  8,253 |  2,106 |  1,961 |

| internal.1 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,192.50 |  12,385 |  8,275 |  4,110 |
| `main_cells_used     ` |  75,078,794 |  150,157,588 |  111,970,477 |  38,187,111 |
| `total_cycles        ` |  1,532,495 |  3,064,990 |  2,298,827 |  766,163 |
| `execute_time_ms     ` |  660 |  1,320 |  993 |  327 |
| `trace_gen_time_ms   ` |  667.50 |  1,335 |  956 |  379 |
| `stark_prove_excluding_trace_time_ms` |  4,865 |  9,730 |  6,326 |  3,404 |
| `main_trace_commit_time_ms` |  828 |  1,656 |  1,142 |  514 |
| `generate_perm_trace_time_ms` |  124.50 |  249 |  179 |  70 |
| `perm_trace_commit_time_ms` |  668.50 |  1,337 |  918 |  419 |
| `quotient_poly_compute_time_ms` |  612 |  1,224 |  866 |  358 |
| `quotient_poly_commit_time_ms` |  1,194.50 |  2,389 |  1,395 |  994 |
| `pcs_opening_time_ms ` |  1,432.50 |  2,865 |  1,822 |  1,043 |

| internal.2 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,046 |  6,046 |  6,046 |  6,046 |
| `main_cells_used     ` |  73,850,850 |  73,850,850 |  73,850,850 |  73,850,850 |
| `total_cycles        ` |  1,516,211 |  1,516,211 |  1,516,211 |  1,516,211 |
| `execute_time_ms     ` |  628 |  628 |  628 |  628 |
| `trace_gen_time_ms   ` |  663 |  663 |  663 |  663 |
| `stark_prove_excluding_trace_time_ms` |  4,755 |  4,755 |  4,755 |  4,755 |
...
| `pcs_opening_time_ms ` |  1,408 |  1,408 |  1,408 |  1,408 |

| root |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  30,751 |  30,751 |  30,751 |  30,751 |
...
| `stark_prove_excluding_trace_time_ms` |  30,082 |  30,082 |  30,082 |  30,082 |
| `main_trace_commit_time_ms` |  8,829 |  8,829 |  8,829 |  8,829 |
| `generate_perm_trace_time_ms` |  73 |  73 |  73 |  73 |
| `perm_trace_commit_time_ms` |  5,502 |  5,502 |  5,502 |  5,502 |
| `quotient_poly_compute_time_ms` |  773 |  773 |  773 |  773 |
| `quotient_poly_commit_time_ms` |  11,422 |  11,422 |  11,422 |  11,422 |
| `pcs_opening_time_ms ` |  3,475 |  3,475 |  3,475 |  3,475 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  55,211 |  55,211 |  55,211 |  55,211 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  15,785.50 |  31,571 |  30,804 |  767 |
...
| `stark_prove_excluding_trace_time_ms` |  15,424.50 |  30,849 |  30,105 |  744 |
| `main_trace_commit_time_ms` |  4,440.50 |  8,881 |  8,797 |  84 |
| `generate_perm_trace_time_ms` |  46.50 |  93 |  69 |  24 |
| `perm_trace_commit_time_ms` |  2,811.50 |  5,623 |  5,531 |  92 |
| `quotient_poly_compute_time_ms` |  405.50 |  811 |  781 |  30 |
| `quotient_poly_commit_time_ms` |  5,710.50 |  11,421 |  11,315 |  106 |
| `pcs_opening_time_ms ` |  2,002 |  4,004 |  3,601 |  403 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 21000000 |