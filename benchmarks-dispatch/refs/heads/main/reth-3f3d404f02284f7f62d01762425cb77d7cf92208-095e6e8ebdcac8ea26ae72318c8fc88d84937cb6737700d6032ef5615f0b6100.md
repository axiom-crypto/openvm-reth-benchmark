...
|:---|---:|---:|
| Total |  801.57 |  228.83 |
| reth.prove_e2e.block_21000000 |  484.06 |  63.04 |
| leaf |  119.35 |  14.35 |
| internal.0 |  36.31 |  6.59 |
| internal.1 |  18.90 |  6.37 |
| internal.2 |  10.76 |  6.29 |
| internal.3 |  6.40 |  6.40 |
| internal.4 |  4.34 |  4.34 |
| root |  29.15 |  29.15 |
| halo2_outer |  53.89 |  53.89 |
| halo2_wrapper |  38.42 |  38.42 |
| agg_keygen |  30.88 |  30.11 |


| reth.prove_e2e.block_21000000 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,005.45 |  484,060 |  63,037 |  12,755 |
| `main_cells_used     ` |  1,143,805,307.36 |  12,581,858,381 |  1,923,840,830 |  289,501,815 |
| `total_cycles        ` |  1,959,760 |  1,959,760 |  1,959,760 |  1,959,760 |
| `execute_time_ms     ` |  3,050.91 |  33,560 |  6,350 |  279 |
| `trace_gen_time_ms   ` |  9,258.09 |  101,839 |  11,627 |  3,149 |
| `stark_prove_excluding_trace_time_ms` |  31,696.45 |  348,661 |  50,383 |  9,327 |
| `main_trace_commit_time_ms` |  8,074.91 |  88,824 |  16,781 |  2,150 |
| `generate_perm_trace_time_ms` |  991.73 |  10,909 |  1,246 |  254 |
| `perm_trace_commit_time_ms` |  4,648.45 |  51,133 |  5,929 |  1,419 |
| `quotient_poly_compute_time_ms` |  6,200.09 |  68,201 |  13,548 |  1,229 |
| `quotient_poly_commit_time_ms` |  4,975.73 |  54,733 |  6,262 |  1,866 |
| `pcs_opening_time_ms ` |  6,793.18 |  74,725 |  8,128 |  2,398 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,849.82 |  119,348 |  14,351 |  9,445 |
| `main_cells_used     ` |  115,677,937.09 |  1,272,457,308 |  171,122,589 |  81,956,254 |
| `total_cycles        ` |  1,528,635.27 |  16,814,988 |  2,246,998 |  1,036,902 |
| `execute_time_ms     ` |  564.73 |  6,212 |  716 |  446 |
| `trace_gen_time_ms   ` |  1,070.55 |  11,776 |  1,519 |  799 |
| `stark_prove_excluding_trace_time_ms` |  9,214.55 |  101,360 |  12,116 |  8,173 |
| `main_trace_commit_time_ms` |  1,514 |  16,654 |  2,105 |  1,272 |
| `generate_perm_trace_time_ms` |  233.45 |  2,568 |  336 |  162 |
| `perm_trace_commit_time_ms` |  1,393.36 |  15,327 |  2,004 |  1,151 |
| `quotient_poly_compute_time_ms` |  1,010.73 |  11,118 |  1,602 |  786 |
| `quotient_poly_commit_time_ms` |  2,135.55 |  23,491 |  2,703 |  1,900 |
| `pcs_opening_time_ms ` |  2,923.55 |  32,159 |  3,363 |  2,725 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,052 |  36,312 |  6,594 |  4,286 |
| `main_cells_used     ` |  63,700,922 |  382,205,532 |  69,402,987 |  35,533,134 |
| `total_cycles        ` |  1,137,854.67 |  6,827,128 |  1,241,653 |  620,676 |
| `execute_time_ms     ` |  627 |  3,762 |  696 |  341 |
| `trace_gen_time_ms   ` |  562 |  3,372 |  621 |  328 |
| `stark_prove_excluding_trace_time_ms` |  4,863 |  29,178 |  5,291 |  3,617 |
| `main_trace_commit_time_ms` |  780.17 |  4,681 |  837 |  548 |
| `generate_perm_trace_time_ms` |  125.83 |  755 |  165 |  82 |
| `perm_trace_commit_time_ms` |  696.83 |  4,181 |  782 |  489 |
| `quotient_poly_compute_time_ms` |  497.83 |  2,987 |  544 |  308 |
| `quotient_poly_commit_time_ms` |  1,362 |  8,172 |  1,469 |  1,112 |
| `pcs_opening_time_ms ` |  1,395.83 |  8,375 |  1,597 |  1,074 |

| internal.1 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,298.67 |  18,896 |  6,367 |  6,212 |
| `main_cells_used     ` |  66,203,274 |  198,609,822 |  66,387,565 |  65,835,052 |
| `total_cycles        ` |  1,211,637.67 |  3,634,913 |  1,214,231 |  1,206,491 |
| `execute_time_ms     ` |  616.67 |  1,850 |  626 |  601 |
| `trace_gen_time_ms   ` |  585 |  1,755 |  588 |  582 |
| `stark_prove_excluding_trace_time_ms` |  5,097 |  15,291 |  5,184 |  5,004 |
| `main_trace_commit_time_ms` |  819.67 |  2,459 |  834 |  810 |
| `generate_perm_trace_time_ms` |  134.67 |  404 |  165 |  116 |
| `perm_trace_commit_time_ms` |  723 |  2,169 |  756 |  697 |
| `quotient_poly_compute_time_ms` |  533.67 |  1,601 |  538 |  527 |
| `quotient_poly_commit_time_ms` |  1,403.67 |  4,211 |  1,442 |  1,381 |
| `pcs_opening_time_ms ` |  1,478 |  4,434 |  1,510 |  1,430 |

| internal.2 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,378.50 |  10,757 |  6,288 |  4,469 |
| `main_cells_used     ` |  50,221,992 |  100,443,984 |  66,386,872 |  34,057,112 |
| `total_cycles        ` |  910,803 |  1,821,606 |  1,214,154 |  607,452 |
| `execute_time_ms     ` |  461.50 |  923 |  612 |  311 |
| `trace_gen_time_ms   ` |  458 |  916 |  585 |  331 |
| `stark_prove_excluding_trace_time_ms` |  4,459 |  8,918 |  5,091 |  3,827 |
| `main_trace_commit_time_ms` |  691 |  1,382 |  817 |  565 |
| `generate_perm_trace_time_ms` |  120.50 |  241 |  181 |  60 |
| `perm_trace_commit_time_ms` |  700 |  1,400 |  733 |  667 |
| `quotient_poly_compute_time_ms` |  429.50 |  859 |  539 |  320 |
| `quotient_poly_commit_time_ms` |  1,238.50 |  2,477 |  1,370 |  1,107 |
| `pcs_opening_time_ms ` |  1,275.50 |  2,551 |  1,447 |  1,104 |

| internal.3 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,398 |  6,398 |  6,398 |  6,398 |
| `main_cells_used     ` |  65,834,710 |  65,834,710 |  65,834,710 |  65,834,710 |
| `total_cycles        ` |  1,206,453 |  1,206,453 |  1,206,453 |  1,206,453 |
| `execute_time_ms     ` |  608 |  608 |  608 |  608 |
| `trace_gen_time_ms   ` |  582 |  582 |  582 |  582 |
| `stark_prove_excluding_trace_time_ms` |  5,208 |  5,208 |  5,208 |  5,208 |
...
| `pcs_opening_time_ms ` |  1,442 |  1,442 |  1,442 |  1,442 |
...
| `stark_prove_excluding_trace_time_ms` |  3,698 |  3,698 |  3,698 |  3,698 |
...
| `quotient_poly_commit_time_ms` |  1,178 |  1,178 |  1,178 |  1,178 |
| `pcs_opening_time_ms ` |  1,092 |  1,092 |  1,092 |  1,092 |

| root |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  29,148 |  29,148 |  29,148 |  29,148 |
| `main_cells_used     ` |  33,388,504 |  33,388,504 |  33,388,504 |  33,388,504 |
| `total_cycles        ` |  600,180 |  600,180 |  600,180 |  600,180 |
| `execute_time_ms     ` |  295 |  295 |  295 |  295 |
| `trace_gen_time_ms   ` |  324 |  324 |  324 |  324 |
| `stark_prove_excluding_trace_time_ms` |  28,529 |  28,529 |  28,529 |  28,529 |
| `main_trace_commit_time_ms` |  8,100 |  8,100 |  8,100 |  8,100 |
| `generate_perm_trace_time_ms` |  66 |  66 |  66 |  66 |
| `perm_trace_commit_time_ms` |  5,722 |  5,722 |  5,722 |  5,722 |
| `quotient_poly_compute_time_ms` |  622 |  622 |  622 |  622 |
| `quotient_poly_commit_time_ms` |  10,602 |  10,602 |  10,602 |  10,602 |
| `pcs_opening_time_ms ` |  3,413 |  3,413 |  3,413 |  3,413 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  53,890 |  53,890 |  53,890 |  53,890 |
| `main_cells_used     ` |  58,076,647 |  58,076,647 |  58,076,647 |  58,076,647 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  38,422 |  38,422 |  38,422 |  38,422 |

| agg_keygen |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  15,439.50 |  30,879 |  30,106 |  773 |
| `main_cells_used     ` |  41,064,446.50 |  82,128,893 |  81,200,824 |  928,069 |
| `total_cycles        ` |  1,358,070 |  1,358,070 |  1,358,070 |  1,358,070 |
| `execute_time_ms     ` |  143 |  286 |  286 |  0 |
| `trace_gen_time_ms   ` |  181.50 |  363 |  338 |  25 |
| `stark_prove_excluding_trace_time_ms` |  15,115 |  30,230 |  29,482 |  748 |
| `main_trace_commit_time_ms` |  4,101 |  8,202 |  8,115 |  87 |
| `generate_perm_trace_time_ms` |  69 |  138 |  112 |  26 |
| `perm_trace_commit_time_ms` |  2,993.50 |  5,987 |  5,875 |  112 |
| `quotient_poly_compute_time_ms` |  324 |  648 |  612 |  36 |
| `quotient_poly_commit_time_ms` |  5,694 |  11,388 |  11,275 |  113 |
| `pcs_opening_time_ms ` |  1,929.50 |  3,859 |  3,488 |  371 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 21000000 | 338 | 30,106 | 1,358,070 | 196,035,544 | 29,482 | 612 | 11,275 | 5,875 | 3,488 | 1 | 8,115 | 81,200,824 | 7,911,006 | 19,798 | 112 | 286 | 
| halo2_outer | 21000000 |  | 53,890 |  |  |  |  |  |  |  |  |  | 58,076,647 |  |  |  |  | 
| halo2_wrapper | 21000000 |  | 38,422 |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 21000000 | 0 | 621 | 6,413 | 1,241,387 | 167,723,992 | 5,123 | 544 | 1,411 | 782 | 1,417 | 837 | 69,402,987 | 126 | 669 | 
| internal.0 | 21000000 | 1 | 613 | 6,358 | 1,240,563 | 167,723,992 | 5,067 | 530 | 1,397 | 719 | 1,420 | 832 | 69,359,025 | 165 | 678 | 
| internal.0 | 21000000 | 2 | 603 | 6,326 | 1,241,653 | 167,723,992 | 5,027 | 542 | 1,378 | 733 | 1,424 | 801 | 69,291,373 | 144 | 696 | 
