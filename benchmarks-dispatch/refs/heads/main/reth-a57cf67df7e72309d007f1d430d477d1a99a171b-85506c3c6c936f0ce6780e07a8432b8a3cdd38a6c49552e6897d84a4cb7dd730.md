...
|:---|---:|---:|
| Total |  608.95 |  198.07 |
| reth.prove_evm.block_21000000 |  315.45 |  36.88 |
| leaf |  105.80 |  11.52 |
| internal.0 |  46.08 |  12.31 |
| internal.1 |  12.49 |  8.24 |
| internal.2 |  6.12 |  6.12 |
| root |  30.100 |  30.100 |
| halo2_outer |  53.42 |  53.42 |
| halo2_wrapper |  38.60 |  38.60 |
| agg_keygen |  31.97 |  31.22 |


| reth.prove_evm.block_21000000 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  28,676.91 |  315,446 |  36,875 |  15,770 |
| `main_cells_used     ` |  1,152,567,563.73 |  12,678,243,201 |  1,513,540,876 |  734,507,488 |
| `total_cycles        ` |  18,582,180.27 |  204,403,983 |  24,897,409 |  4,949,486 |
| `execute_time_ms     ` |  2,904.27 |  31,947 |  6,161 |  735 |
| `trace_gen_time_ms   ` |  9,138.18 |  100,520 |  11,453 |  4,785 |
| `stark_prove_excluding_trace_time_ms` |  16,634.45 |  182,979 |  20,072 |  10,025 |
| `main_trace_commit_time_ms` |  4,102.18 |  45,124 |  6,888 |  2,913 |
| `generate_perm_trace_time_ms` |  1,038.91 |  11,428 |  1,238 |  420 |
| `perm_trace_commit_time_ms` |  3,158.82 |  34,747 |  3,892 |  1,474 |
| `quotient_poly_compute_time_ms` |  3,110.82 |  34,219 |  5,797 |  2,240 |
| `quotient_poly_commit_time_ms` |  1,306.27 |  14,369 |  1,557 |  831 |
| `pcs_opening_time_ms ` |  3,903.91 |  42,943 |  4,654 |  2,136 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  9,618.36 |  105,802 |  11,518 |  7,172 |
| `main_cells_used     ` |  222,475,651.18 |  2,447,232,163 |  278,432,066 |  155,251,861 |
| `total_cycles        ` |  2,809,169.18 |  30,900,861 |  3,459,099 |  2,024,337 |
| `execute_time_ms     ` |  1,248.18 |  13,730 |  1,446 |  1,013 |
| `trace_gen_time_ms   ` |  1,868.73 |  20,556 |  2,346 |  1,351 |
| `stark_prove_excluding_trace_time_ms` |  6,501.45 |  71,516 |  7,814 |  4,788 |
| `main_trace_commit_time_ms` |  1,135.82 |  12,494 |  1,376 |  763 |
| `generate_perm_trace_time_ms` |  411.09 |  4,522 |  582 |  274 |
| `perm_trace_commit_time_ms` |  1,475.55 |  16,231 |  1,860 |  1,033 |
| `quotient_poly_compute_time_ms` |  902.45 |  9,927 |  1,112 |  617 |
| `quotient_poly_commit_time_ms` |  720.09 |  7,921 |  871 |  585 |
| `pcs_opening_time_ms ` |  1,851.45 |  20,366 |  2,215 |  1,488 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,519.75 |  46,079 |  12,306 |  9,550 |
| `main_cells_used     ` |  194,828,051 |  779,312,204 |  214,270,364 |  140,443,454 |
| `total_cycles        ` |  3,276,517 |  13,106,068 |  3,596,453 |  2,365,535 |
| `execute_time_ms     ` |  1,985.25 |  7,941 |  2,258 |  1,384 |
| `trace_gen_time_ms   ` |  1,578 |  6,312 |  1,732 |  1,159 |
| `stark_prove_excluding_trace_time_ms` |  7,956.50 |  31,826 |  8,340 |  7,007 |
| `main_trace_commit_time_ms` |  1,546 |  6,184 |  1,648 |  1,269 |
| `generate_perm_trace_time_ms` |  322 |  1,288 |  361 |  268 |
| `perm_trace_commit_time_ms` |  1,195.25 |  4,781 |  1,256 |  1,045 |
| `quotient_poly_compute_time_ms` |  1,215.50 |  4,862 |  1,302 |  1,001 |
| `quotient_poly_commit_time_ms` |  1,618.25 |  6,473 |  1,683 |  1,478 |
| `pcs_opening_time_ms ` |  2,054 |  8,216 |  2,157 |  1,908 |

| internal.1 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,244 |  12,488 |  8,240 |  4,248 |
| `main_cells_used     ` |  75,079,232 |  150,158,464 |  111,970,957 |  38,187,507 |
| `total_cycles        ` |  1,532,531.50 |  3,065,063 |  2,298,867 |  766,196 |
| `execute_time_ms     ` |  662.50 |  1,325 |  991 |  334 |
| `trace_gen_time_ms   ` |  672.50 |  1,345 |  984 |  361 |
| `stark_prove_excluding_trace_time_ms` |  4,909 |  9,818 |  6,265 |  3,553 |
| `main_trace_commit_time_ms` |  830 |  1,660 |  1,154 |  506 |
| `generate_perm_trace_time_ms` |  135.50 |  271 |  193 |  78 |
| `perm_trace_commit_time_ms` |  684.50 |  1,369 |  890 |  479 |
| `quotient_poly_compute_time_ms` |  597.50 |  1,195 |  842 |  353 |
| `quotient_poly_commit_time_ms` |  1,200.50 |  2,401 |  1,378 |  1,023 |
| `pcs_opening_time_ms ` |  1,456 |  2,912 |  1,803 |  1,109 |

| internal.2 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,115 |  6,115 |  6,115 |  6,115 |
| `main_cells_used     ` |  73,851,666 |  73,851,666 |  73,851,666 |  73,851,666 |
| `total_cycles        ` |  1,516,279 |  1,516,279 |  1,516,279 |  1,516,279 |
| `execute_time_ms     ` |  627 |  627 |  627 |  627 |
| `trace_gen_time_ms   ` |  686 |  686 |  686 |  686 |
| `stark_prove_excluding_trace_time_ms` |  4,802 |  4,802 |  4,802 |  4,802 |
| `main_trace_commit_time_ms` |  839 |  839 |  839 |  839 |
| `generate_perm_trace_time_ms` |  140 |  140 |  140 |  140 |
| `perm_trace_commit_time_ms` |  668 |  668 |  668 |  668 |
| `quotient_poly_compute_time_ms` |  597 |  597 |  597 |  597 |
| `quotient_poly_commit_time_ms` |  1,152 |  1,152 |  1,152 |  1,152 |
| `pcs_opening_time_ms ` |  1,401 |  1,401 |  1,401 |  1,401 |

| root |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  30,997 |  30,997 |  30,997 |  30,997 |
...
| `stark_prove_excluding_trace_time_ms` |  30,337 |  30,337 |  30,337 |  30,337 |
| `main_trace_commit_time_ms` |  8,980 |  8,980 |  8,980 |  8,980 |
...
| `quotient_poly_commit_time_ms` |  11,437 |  11,437 |  11,437 |  11,437 |
| `pcs_opening_time_ms ` |  3,471 |  3,471 |  3,471 |  3,471 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  53,423 |  53,423 |  53,423 |  53,423 |
| `main_cells_used     ` |  62,800,919 |  62,800,919 |  62,800,919 |  62,800,919 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  38,601 |  38,601 |  38,601 |  38,601 |

| agg_keygen |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  15,984.50 |  31,969 |  31,224 |  745 |
...
| `stark_prove_excluding_trace_time_ms` |  15,636 |  31,272 |  30,553 |  719 |
| `main_trace_commit_time_ms` |  4,506.50 |  9,013 |  8,927 |  86 |
| `generate_perm_trace_time_ms` |  48 |  96 |  90 |  6 |
| `perm_trace_commit_time_ms` |  2,877.50 |  5,755 |  5,670 |  85 |
| `quotient_poly_compute_time_ms` |  416 |  832 |  802 |  30 |
| `quotient_poly_commit_time_ms` |  5,759 |  11,518 |  11,411 |  107 |
| `pcs_opening_time_ms ` |  2,021.50 |  4,043 |  3,643 |  400 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 21000000 | 358 | 31,224 | 1,636,891 | 270,872,042 | 30,553 | 802 | 11,411 | 5,670 | 3,643 | 1 | 8,927 | 86,883,637 | 8,037,489 | 20,086 | 90 | 313 | 
| halo2_outer | 21000000 |  | 53,423 |  |  |  |  |  |  |  |  |  | 62,800,919 |  |  |  |  | 
| halo2_wrapper | 21000000 |  | 38,601 |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 21000000 | 0 | 1,713 | 12,135 | 3,563,929 | 472,992,226 | 8,266 | 1,302 | 1,659 | 1,235 | 2,056 | 1,648 | 211,571,939 | 359 | 2,156 | 
| internal.0 | 21000000 | 1 | 1,732 | 12,088 | 3,580,151 | 472,992,226 | 8,213 | 1,277 | 1,683 | 1,256 | 2,095 | 1,629 | 213,026,447 | 268 | 2,143 | 
| internal.0 | 21000000 | 2 | 1,708 | 12,306 | 3,596,453 | 472,992,226 | 8,340 | 1,282 | 1,653 | 1,245 | 2,157 | 1,638 | 214,270,364 | 361 | 2,258 | 
| internal.0 | 21000000 | 3 | 1,159 | 9,550 | 2,365,535 | 346,728,930 | 7,007 | 1,001 | 1,478 | 1,045 | 1,908 | 1,269 | 140,443,454 | 300 | 1,384 | 
| internal.1 | 21000000 | 4 | 984 | 8,240 | 2,298,867 | 300,984,802 | 6,265 | 842 | 1,378 | 890 | 1,803 | 1,154 | 111,970,957 | 193 | 991 | 
| internal.1 | 21000000 | 5 | 361 | 4,248 | 766,196 | 95,656,418 | 3,553 | 353 | 1,023 | 479 | 1,109 | 506 | 38,187,507 | 78 | 334 | 
| internal.2 | 21000000 | 6 | 686 | 6,115 | 1,516,279 | 186,591,714 | 4,802 | 597 | 1,152 | 668 | 1,401 | 839 | 73,851,666 | 140 | 627 | 
| leaf | 21000000 | 0 | 2,058 | 10,644 | 3,028,733 | 1,037,143,530 | 7,261 | 1,008 | 769 | 1,704 | 2,022 | 1,237 | 247,922,656 | 515 | 1,325 | 
| leaf | 21000000 | 1 | 1,355 | 7,462 | 2,040,183 | 664,751,594 | 5,034 | 685 | 585 | 1,063 | 1,546 | 855 | 156,789,530 | 294 | 1,073 | 
| leaf | 21000000 | 10 | 1,445 | 7,775 | 2,256,925 | 732,909,034 | 5,317 | 719 | 594 | 1,146 | 1,541 | 960 | 168,404,260 | 352 | 1,013 | 
| leaf | 21000000 | 2 | 1,374 | 7,450 | 2,040,159 | 664,751,594 | 5,021 | 680 | 619 | 1,052 | 1,488 | 899 | 156,790,255 | 278 | 1,055 | 
| leaf | 21000000 | 3 | 1,351 | 7,172 | 2,024,337 | 571,690,474 | 4,788 | 617 | 598 | 1,033 | 1,498 | 763 | 155,251,861 | 274 | 1,033 | 
| leaf | 21000000 | 4 | 2,346 | 11,473 | 3,459,099 | 1,100,058,090 | 7,681 | 1,112 | 816 | 1,810 | 2,107 | 1,359 | 278,251,814 | 473 | 1,446 | 
