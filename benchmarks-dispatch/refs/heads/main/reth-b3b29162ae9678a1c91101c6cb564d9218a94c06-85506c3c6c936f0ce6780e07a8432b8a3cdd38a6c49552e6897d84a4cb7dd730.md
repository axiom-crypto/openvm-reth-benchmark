...
|:---|---:|---:|
| Total |  611.89 |  199.33 |
| reth.prove_evm.block_21000000 |  317.01 |  36.98 |
| leaf |  106.21 |  11.58 |
| internal.0 |  45.93 |  12.19 |
| internal.1 |  12.55 |  8.39 |
| internal.2 |  6.08 |  6.08 |
| root |  31.18 |  31.18 |
| halo2_outer |  54.25 |  54.25 |
| halo2_wrapper |  38.68 |  38.68 |
| agg_keygen |  32.13 |  31.37 |


| reth.prove_evm.block_21000000 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  28,819.36 |  317,013 |  36,985 |  15,786 |
| `main_cells_used     ` |  1,152,653,518.82 |  12,679,188,707 |  1,513,542,332 |  734,655,540 |
| `total_cycles        ` |  18,582,180.27 |  204,403,983 |  24,897,409 |  4,949,486 |
| `execute_time_ms     ` |  2,902.18 |  31,924 |  6,176 |  735 |
| `trace_gen_time_ms   ` |  9,206.36 |  101,270 |  11,738 |  4,735 |
| `stark_prove_excluding_trace_time_ms` |  16,710.82 |  183,819 |  20,156 |  10,009 |
| `main_trace_commit_time_ms` |  4,096.45 |  45,061 |  6,867 |  2,923 |
| `generate_perm_trace_time_ms` |  1,053.64 |  11,590 |  1,251 |  482 |
| `perm_trace_commit_time_ms` |  3,169.64 |  34,866 |  3,845 |  1,476 |
| `quotient_poly_compute_time_ms` |  3,110.36 |  34,214 |  5,824 |  2,237 |
| `quotient_poly_commit_time_ms` |  1,322.27 |  14,545 |  1,661 |  743 |
| `pcs_opening_time_ms ` |  3,945.45 |  43,400 |  4,783 |  2,139 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  9,655.36 |  106,209 |  11,580 |  7,008 |
| `main_cells_used     ` |  222,475,478.82 |  2,447,230,267 |  278,431,934 |  155,251,381 |
| `total_cycles        ` |  2,809,154.82 |  30,900,703 |  3,459,081 |  2,024,297 |
| `execute_time_ms     ` |  1,244.91 |  13,694 |  1,429 |  1,005 |
| `trace_gen_time_ms   ` |  1,864.27 |  20,507 |  2,312 |  1,360 |
| `stark_prove_excluding_trace_time_ms` |  6,546.18 |  72,008 |  7,879 |  4,643 |
| `main_trace_commit_time_ms` |  1,138.45 |  12,523 |  1,378 |  759 |
| `generate_perm_trace_time_ms` |  423.55 |  4,659 |  567 |  256 |
| `perm_trace_commit_time_ms` |  1,477.45 |  16,252 |  1,820 |  986 |
| `quotient_poly_compute_time_ms` |  900.73 |  9,908 |  1,108 |  596 |
| `quotient_poly_commit_time_ms` |  719.27 |  7,912 |  842 |  564 |
| `pcs_opening_time_ms ` |  1,881.45 |  20,696 |  2,236 |  1,477 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,481.75 |  45,927 |  12,190 |  9,625 |
| `main_cells_used     ` |  194,828,498 |  779,313,992 |  214,269,524 |  140,442,770 |
| `total_cycles        ` |  3,276,554.25 |  13,106,217 |  3,596,383 |  2,365,478 |
| `execute_time_ms     ` |  1,983 |  7,932 |  2,190 |  1,411 |
| `trace_gen_time_ms   ` |  1,562 |  6,248 |  1,714 |  1,153 |
| `stark_prove_excluding_trace_time_ms` |  7,936.75 |  31,747 |  8,333 |  7,061 |
| `main_trace_commit_time_ms` |  1,546.75 |  6,187 |  1,658 |  1,272 |
| `generate_perm_trace_time_ms` |  267.75 |  1,071 |  281 |  239 |
| `perm_trace_commit_time_ms` |  1,191.50 |  4,766 |  1,248 |  1,069 |
| `quotient_poly_compute_time_ms` |  1,209 |  4,836 |  1,279 |  1,007 |
| `quotient_poly_commit_time_ms` |  1,634 |  6,536 |  1,714 |  1,511 |
| `pcs_opening_time_ms ` |  2,082.25 |  8,329 |  2,175 |  1,957 |

| internal.1 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,275.50 |  12,551 |  8,391 |  4,160 |
| `main_cells_used     ` |  75,079,292 |  150,158,584 |  111,971,677 |  38,186,907 |
| `total_cycles        ` |  1,532,536.50 |  3,065,073 |  2,298,927 |  766,146 |
| `execute_time_ms     ` |  659 |  1,318 |  980 |  338 |
| `trace_gen_time_ms   ` |  674 |  1,348 |  989 |  359 |
| `stark_prove_excluding_trace_time_ms` |  4,942.50 |  9,885 |  6,422 |  3,463 |
| `main_trace_commit_time_ms` |  849 |  1,698 |  1,170 |  528 |
| `generate_perm_trace_time_ms` |  125.50 |  251 |  181 |  70 |
| `perm_trace_commit_time_ms` |  679 |  1,358 |  930 |  428 |
| `quotient_poly_compute_time_ms` |  618 |  1,236 |  876 |  360 |
| `quotient_poly_commit_time_ms` |  1,220 |  2,440 |  1,453 |  987 |
| `pcs_opening_time_ms ` |  1,445 |  2,890 |  1,806 |  1,084 |

| internal.2 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,077 |  6,077 |  6,077 |  6,077 |
| `main_cells_used     ` |  73,850,586 |  73,850,586 |  73,850,586 |  73,850,586 |
| `total_cycles        ` |  1,516,189 |  1,516,189 |  1,516,189 |  1,516,189 |
...
| `main_cells_used     ` |  37,521,615 |  37,521,615 |  37,521,615 |  37,521,615 |
| `total_cycles        ` |  759,167 |  759,167 |  759,167 |  759,167 |
| `execute_time_ms     ` |  316 |  316 |  316 |  316 |
| `trace_gen_time_ms   ` |  358 |  358 |  358 |  358 |
| `stark_prove_excluding_trace_time_ms` |  30,505 |  30,505 |  30,505 |  30,505 |
| `main_trace_commit_time_ms` |  8,898 |  8,898 |  8,898 |  8,898 |
| `generate_perm_trace_time_ms` |  107 |  107 |  107 |  107 |
| `perm_trace_commit_time_ms` |  5,623 |  5,623 |  5,623 |  5,623 |
| `quotient_poly_compute_time_ms` |  768 |  768 |  768 |  768 |
| `quotient_poly_commit_time_ms` |  11,530 |  11,530 |  11,530 |  11,530 |
| `pcs_opening_time_ms ` |  3,565 |  3,565 |  3,565 |  3,565 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  54,253 |  54,253 |  54,253 |  54,253 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  16,063 |  32,126 |  31,374 |  752 |
| `main_cells_used     ` |  43,446,706.50 |  86,893,413 |  86,882,857 |  10,556 |
| `total_cycles        ` |  1,636,826 |  1,636,826 |  1,636,826 |  1,636,826 |
| `execute_time_ms     ` |  158.50 |  317 |  317 |  0 |
| `trace_gen_time_ms   ` |  196 |  392 |  367 |  25 |
| `stark_prove_excluding_trace_time_ms` |  15,708.50 |  31,417 |  30,690 |  727 |
| `main_trace_commit_time_ms` |  4,497.50 |  8,995 |  8,904 |  91 |
| `generate_perm_trace_time_ms` |  42 |  84 |  78 |  6 |
| `perm_trace_commit_time_ms` |  2,846.50 |  5,693 |  5,609 |  84 |
| `quotient_poly_compute_time_ms` |  414.50 |  829 |  795 |  34 |
| `quotient_poly_commit_time_ms` |  5,848 |  11,696 |  11,585 |  111 |
| `pcs_opening_time_ms ` |  2,053 |  4,106 |  3,710 |  396 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 21000000 | 367 |