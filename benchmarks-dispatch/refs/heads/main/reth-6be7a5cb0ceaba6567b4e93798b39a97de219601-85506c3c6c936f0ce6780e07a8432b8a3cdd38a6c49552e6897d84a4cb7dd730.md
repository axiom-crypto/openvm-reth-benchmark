...
|:---|---:|---:|
| Total |  602.18 |  195.64 |
| reth.prove_evm.block_21000000 |  313.46 |  36.77 |
| leaf |  104.30 |  11.35 |
| internal.0 |  44.72 |  11.87 |
| internal.1 |  12.05 |  7.99 |
| internal.2 |  5.90 |  5.90 |
| root |  30.61 |  30.61 |
| halo2_outer |  52.47 |  52.47 |
| halo2_wrapper |  38.67 |  38.67 |
| agg_keygen |  31.15 |  30.42 |


| reth.prove_evm.block_21000000 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  28,496.55 |  313,462 |  36,768 |  15,491 |
| `main_cells_used     ` |  1,152,581,180.45 |  12,678,392,985 |  1,513,541,904 |  734,555,448 |
| `total_cycles        ` |  18,582,180.27 |  204,403,983 |  24,897,409 |  4,949,486 |
| `execute_time_ms     ` |  2,932 |  32,252 |  6,248 |  743 |
| `trace_gen_time_ms   ` |  9,188.36 |  101,072 |  11,811 |  4,684 |
| `stark_prove_excluding_trace_time_ms` |  16,376.18 |  180,138 |  19,808 |  9,721 |
| `main_trace_commit_time_ms` |  4,052.64 |  44,579 |  6,895 |  2,798 |
| `generate_perm_trace_time_ms` |  1,023 |  11,253 |  1,226 |  406 |
| `perm_trace_commit_time_ms` |  3,102.64 |  34,129 |  3,793 |  1,446 |
| `quotient_poly_compute_time_ms` |  3,076.91 |  33,846 |  5,733 |  2,201 |
| `quotient_poly_commit_time_ms` |  1,277.36 |  14,051 |  1,627 |  746 |
| `pcs_opening_time_ms ` |  3,831.18 |  42,143 |  4,614 |  2,115 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  9,482.09 |  104,303 |  11,354 |  7,117 |
| `main_cells_used     ` |  222,475,738.45 |  2,447,233,123 |  278,431,586 |  155,251,213 |
| `total_cycles        ` |  2,809,176.45 |  30,900,941 |  3,459,147 |  2,024,283 |
| `execute_time_ms     ` |  1,232.45 |  13,557 |  1,429 |  1,007 |
| `trace_gen_time_ms   ` |  1,862.18 |  20,484 |  2,298 |  1,343 |
| `stark_prove_excluding_trace_time_ms` |  6,387.45 |  70,262 |  7,717 |  4,744 |
| `main_trace_commit_time_ms` |  1,114.82 |  12,263 |  1,360 |  734 |
| `generate_perm_trace_time_ms` |  401.73 |  4,419 |  508 |  280 |
| `perm_trace_commit_time_ms` |  1,461.18 |  16,073 |  1,810 |  1,056 |
| `quotient_poly_compute_time_ms` |  889.91 |  9,789 |  1,090 |  607 |
| `quotient_poly_commit_time_ms` |  686.45 |  7,551 |  816 |  541 |
| `pcs_opening_time_ms ` |  1,828.09 |  20,109 |  2,186 |  1,402 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,179.75 |  44,719 |  11,869 |  9,256 |
| `main_cells_used     ` |  194,828,540 |  779,314,160 |  214,269,248 |  140,444,258 |
| `total_cycles        ` |  3,276,557.75 |  13,106,231 |  3,596,360 |  2,365,602 |
| `execute_time_ms     ` |  1,968.25 |  7,873 |  2,153 |  1,429 |
| `trace_gen_time_ms   ` |  1,569.25 |  6,277 |  1,743 |  1,124 |
| `stark_prove_excluding_trace_time_ms` |  7,642.25 |  30,569 |  7,995 |  6,703 |
| `main_trace_commit_time_ms` |  1,521.50 |  6,086 |  1,614 |  1,278 |
| `generate_perm_trace_time_ms` |  282.50 |  1,130 |  341 |  211 |
| `perm_trace_commit_time_ms` |  1,160.25 |  4,641 |  1,219 |  1,026 |
| `quotient_poly_compute_time_ms` |  1,200.25 |  4,801 |  1,266 |  1,005 |
| `quotient_poly_commit_time_ms` |  1,474.25 |  5,897 |  1,524 |  1,347 |
| `pcs_opening_time_ms ` |  1,998.75 |  7,995 |  2,059 |  1,831 |

| internal.1 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,023 |  12,046 |  7,992 |  4,054 |
| `main_cells_used     ` |  75,078,740 |  150,157,480 |  111,969,865 |  38,187,615 |
| `total_cycles        ` |  1,532,490.50 |  3,064,981 |  2,298,776 |  766,205 |
| `execute_time_ms     ` |  646 |  1,292 |  966 |  326 |
| `trace_gen_time_ms   ` |  660 |  1,320 |  963 |  357 |
| `stark_prove_excluding_trace_time_ms` |  4,717 |  9,434 |  6,063 |  3,371 |
| `main_trace_commit_time_ms` |  827.50 |  1,655 |  1,134 |  521 |
| `generate_perm_trace_time_ms` |  127.50 |  255 |  176 |  79 |
| `perm_trace_commit_time_ms` |  660 |  1,320 |  864 |  456 |
| `quotient_poly_compute_time_ms` |  602.50 |  1,205 |  853 |  352 |
| `quotient_poly_commit_time_ms` |  1,099 |  2,198 |  1,295 |  903 |
| `pcs_opening_time_ms ` |  1,395 |  2,790 |  1,735 |  1,055 |

| internal.2 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,900 |  5,900 |  5,900 |  5,900 |
...
| `stark_prove_excluding_trace_time_ms` |  4,625 |  4,625 |  4,625 |  4,625 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  30,614 |  30,614 |  30,614 |  30,614 |
...
| `main_trace_commit_time_ms` |  8,963 |  8,963 |  8,963 |  8,963 |
| `generate_perm_trace_time_ms` |  64 |  64 |  64 |  64 |
| `perm_trace_commit_time_ms` |  5,476 |  5,476 |  5,476 |  5,476 |
| `quotient_poly_compute_time_ms` |  778 |  778 |  778 |  778 |
| `quotient_poly_commit_time_ms` |  11,282 |  11,282 |  11,282 |  11,282 |
| `pcs_opening_time_ms ` |  3,362 |  3,362 |  3,362 |  3,362 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  52,467 |  52,467 |  52,467 |  52,467 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  15,575.50 |  31,151 |  30,416 |  735 |
...
| `stark_prove_excluding_trace_time_ms` |  15,219 |  30,438 |  29,728 |  710 |
| `main_trace_commit_time_ms` |  4,428.50 |  8,857 |  8,777 |  80 |
| `generate_perm_trace_time_ms` |  52 |  104 |  79 |  25 |
| `perm_trace_commit_time_ms` |  2,764.50 |  5,529 |  5,455 |  74 |
| `quotient_poly_compute_time_ms` |  409.50 |  819 |  783 |  36 |
| `quotient_poly_commit_time_ms` |  5,595.50 |  11,191 |  11,088 |  103 |
| `pcs_opening_time_ms ` |  1,960.50 |  3,921 |  3,534 |  387 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 21000000 | 373 | 30,416 | 1,636,891 | 270,872,042 | 29,728 | 783 | 11,088 | 5,455 | 3,534 | 1 | 8,777 | 86,883,637 | 8,037,489 | 19,948 | 79 | 315 | 
| halo2_outer | 21000000 |  | 52,467 |  |  |  |  |  |  |  |  |  | 62,800,919 |  |  |  |  | 
| halo2_wrapper | 21000000 |  | 38