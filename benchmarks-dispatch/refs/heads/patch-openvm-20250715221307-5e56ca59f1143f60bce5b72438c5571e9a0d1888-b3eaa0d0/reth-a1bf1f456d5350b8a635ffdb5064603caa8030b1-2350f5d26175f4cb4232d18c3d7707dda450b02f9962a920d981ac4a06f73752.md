...
| `execute_e1_time_ms  ` |  1,442 |  1,442 |  1,442 |  1,442 |
| `execute_e1_insn_mi/s` |  109.82 | -          |  109.82 |  109.82 |
| `execute_metered_time_ms` |  2,331 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  67.94 | -          |  67.94 |  67.94 |
...
| --- | --- | --- |
| 21000000 | 2,734 | 1,749 | 

| group | block_number | insns | execute_metered_time_ms | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insn_mi/s |
| --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_21000000 | 21000000 | 158,409,922 | 2,331 | 67.94 | 1,442 | 109.82 | 

</details>


Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/actions/runs/16305678462
