...
| `insns               ` |  158,379,579 |  158,379,579 |  158,379,579 |  158,379,579 |
| `execute_e1_time_ms  ` |  1,056 |  1,056 |  1,056 |  1,056 |
| `execute_e1_insn_mi/s` |  149.95 | -          |  149.95 |  149.95 |
| `execute_metered_time_ms` |  1,974 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  80.21 | -          |  80.21 |  80.21 |
...
| --- | --- | --- |
| 21000000 | 2,049 | 1,132 | 

| group | block_number | insns | execute_metered_time_ms | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insn_mi/s |
| --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_21000000 | 21000000 | 158,379,579 | 1,974 | 80.21 | 1,056 | 149.95 | 

</details>


**[Firefox Profiler](https://profiler.firefox.com/public/8g074014dcqkyktxd316z0g4cz2ek9hqpznjjm0)**

Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/actions/runs/16505799915

Max Segment Length: 8388508

Instance Type: m8g.24xlarge

Memory Allocator: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/c77e6cdf30df91c68d155bbb09e316a945b8969d
