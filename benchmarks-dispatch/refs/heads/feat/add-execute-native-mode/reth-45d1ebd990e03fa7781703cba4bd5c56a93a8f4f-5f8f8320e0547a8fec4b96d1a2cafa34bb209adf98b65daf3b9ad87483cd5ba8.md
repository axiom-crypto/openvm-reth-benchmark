...
| `execute_e1_time_ms  ` |  949 |  949 |  949 |  949 |
| `execute_e1_insn_mi/s` |  139.45 | -          |  139.45 |  139.45 |
| `execute_metered_time_ms` |  1,691 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  78.29 | -          |  78.29 |  78.29 |
...
| block_number | sdk.execute_time_ms | native.execute_time_ms | interpreter.execute_metered_time_ms |
| --- | --- | --- | --- |
| 23100006 | 1,252 | 39 | 1,699 | 

| group | block_number | execute_metered_time_ms | execute_metered_insns | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insns | execute_e1_insn_mi/s | client.execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_23100006 | 23100006 | 1,691 | 132,404,931 | 78.29 | 949 | 132,404,931 | 139.45 | 39 | 

</details>


**[Firefox Profiler](https://profiler.firefox.com/public/gkcjr7r4z3ynva7yekmvkrxz5n6n8hfg676kdcg)**

Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/45d1ebd990e03fa7781703cba4bd5c56a93a8f4f
...
[Benchmark Workflow](https://github.com/axiom-crypto/openvm-reth-benchmark/actions/runs/17623286326)
