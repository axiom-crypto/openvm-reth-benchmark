...
| `execute_e1_time_ms  ` |  2,834 |  2,834 |  2,834 |  2,834 |
| `execute_e1_insn_mi/s` |  55.88 | -          |  55.88 |  55.88 |
| `execute_metered_time_ms` |  3,666 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  43.20 | -          |  43.20 |  43.20 |
...
| --- | --- | --- |
| 21000000 | 4,078 | 3,162 | 

| group | block_number | insns | execute_metered_time_ms | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insn_mi/s |
| --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_21000000 | 21000000 | 158,401,170 | 3,666 | 43.20 | 2,834 | 55.88 | 

</details>


Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/8c66865bb5c3d099087ba8df83efebc1630acc9b
...
[Benchmark Workflow](https://github.com/axiom-crypto/openvm-reth-benchmark/actions/runs/16363008894)
