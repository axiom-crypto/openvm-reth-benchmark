...
| `execute_e1_time_ms  ` |  1,065 |  1,065 |  1,065 |  1,065 |
| `execute_e1_insn_mi/s` |  148.64 | -          |  148.64 |  148.64 |
| `execute_metered_time_ms` |  1,962 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  80.75 | -          |  80.75 |  80.75 |
...
| --- | --- | --- |
| 21000000 | 2,354 | 1,372 | 

| group | block_number | insns | execute_metered_time_ms | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insn_mi/s |
| --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_21000000 | 21000000 | 158,449,722 | 1,962 | 80.75 | 1,065 | 148.64 | 

</details>


Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/b2a7f360da6a0b72696b9eecd1814b62647a0d7a
...
[Benchmark Workflow](https://github.com/axiom-crypto/openvm-reth-benchmark/actions/runs/16352365030)
