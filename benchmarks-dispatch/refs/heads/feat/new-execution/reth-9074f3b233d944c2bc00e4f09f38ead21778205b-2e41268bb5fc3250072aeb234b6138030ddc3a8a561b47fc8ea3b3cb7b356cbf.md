...
| `insns               ` |  158,415,123 |  158,415,123 |  158,415,123 |  158,415,123 |
| `execute_e1_time_ms  ` |  1,051 |  1,051 |  1,051 |  1,051 |
| `execute_e1_insn_mi/s` |  150.61 | -          |  150.61 |  150.61 |
| `execute_metered_time_ms` |  1,993 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  79.47 | -          |  79.47 |  79.47 |
...
| --- | --- | --- |
| 21000000 | 2,072 | 1,133 | 

| group | block_number | insns | execute_metered_time_ms | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insn_mi/s |
| --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_21000000 | 21000000 | 158,415,123 | 1,993 | 79.47 | 1,051 | 150.61 | 

</details>


Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/9074f3b233d944c2bc00e4f09f38ead21778205b
...
[Benchmark Workflow](https://github.com/axiom-crypto/openvm-reth-benchmark/actions/runs/16505584717)
