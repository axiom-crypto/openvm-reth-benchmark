...
| `insns               ` |  158,405,899 |  158,405,899 |  158,405,899 |  158,405,899 |
| `execute_e1_time_ms  ` |  1,005 |  1,005 |  1,005 |  1,005 |
| `execute_e1_insn_mi/s` |  157.48 | -          |  157.48 |  157.48 |
| `execute_metered_time_ms` |  1,540 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  102.85 | -          |  102.85 |  102.85 |
...
| --- | --- | --- |
| 21000000 | 1,618 | 1,086 | 

| group | block_number | insns | execute_metered_time_ms | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insn_mi/s |
| --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_21000000 | 21000000 | 158,405,899 | 1,540 | 102.85 | 1,005 | 157.48 | 

</details>


Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/f662217cfd6bd9cf121411913b4d9282791e550d
...
[Benchmark Workflow](https://github.com/axiom-crypto/openvm-reth-benchmark/actions/runs/16540466404)
