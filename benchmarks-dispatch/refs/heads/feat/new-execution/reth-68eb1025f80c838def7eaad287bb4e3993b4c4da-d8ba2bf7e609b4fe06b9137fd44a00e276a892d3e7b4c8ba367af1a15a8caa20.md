...
| `execute_e1_time_ms  ` |  2,770 |  2,770 |  2,770 |  2,770 |
| `execute_e1_insn_mi/s` |  57.18 | -          |  57.18 |  57.18 |
| `execute_metered_time_ms` |  3,709 | -          | -          | -          |
...
| --- | --- | --- |
| 21000000 | 4,092 | 3,069 | 

| group | block_number | insns | execute_metered_time_ms | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insn_mi/s |
| --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_21000000 | 21000000 | 158,411,901 | 3,709 | 42.70 | 2,770 | 57.18 | 

</details>


Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/68eb1025f80c838def7eaad287bb4e3993b4c4da
...
[Benchmark Workflow](https://github.com/axiom-crypto/openvm-reth-benchmark/actions/runs/16375836349)
