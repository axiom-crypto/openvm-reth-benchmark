...
| `execute_e1_time_ms  ` |  6,131 |  6,131 |  6,131 |  6,131 |
| `execute_e1_insn_mi/s` |  25.83 | -          |  25.83 |  25.83 |
| `execute_metered_time_ms` |  11,075 | -          | -          | -          |
...
| --- | --- | --- |
| 21000000 | 11,118 | 6,331 | 

| group | block_number | insns | execute_metered_time_ms | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insn_mi/s |
| --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_21000000 | 21000000 | 158,409,237 | 11,075 | 14.46 | 6,131 | 25.83 | 

</details>


Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/c1b68a63f0195a5f43b9429d703ec1a7d94b6dbe
...
[Benchmark Workflow](https://github.com/axiom-crypto/openvm-reth-benchmark/actions/runs/15927295834)
