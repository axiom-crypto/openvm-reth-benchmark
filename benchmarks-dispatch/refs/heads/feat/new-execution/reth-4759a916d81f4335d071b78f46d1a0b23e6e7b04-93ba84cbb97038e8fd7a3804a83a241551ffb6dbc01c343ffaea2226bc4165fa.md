...
| `execute_e1_time_ms  ` |  2,788 |  2,788 |  2,788 |  2,788 |
| `execute_e1_insn_mi/s` |  56.82 | -          |  56.82 |  56.82 |
| `execute_metered_time_ms` |  3,697 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  42.84 | -          |  42.84 |  42.84 |
...
| --- | --- | --- |
| 21000000 | 4,100 | 3,109 | 

| group | block_number | insns | execute_metered_time_ms | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insn_mi/s |
| --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_21000000 | 21000000 | 158,410,953 | 3,697 | 42.84 | 2,788 | 56.82 | 

</details>


Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/4759a916d81f4335d071b78f46d1a0b23e6e7b04
