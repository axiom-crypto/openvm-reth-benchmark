...
| `execute_e1_time_ms  ` |  2,784 |  2,784 |  2,784 |  2,784 |
| `execute_e1_insn_mi/s` |  56.88 | -          |  56.88 |  56.88 |
| `execute_metered_time_ms` |  3,685 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  42.98 | -          |  42.98 |  42.98 |
...
| --- | --- | --- |
| 21000000 | 4,080 | 3,092 | 

| group | block_number | insns | execute_metered_time_ms | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insn_mi/s |
| --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_21000000 | 21000000 | 158,409,492 | 3,685 | 42.98 | 2,784 | 56.88 | 

</details>


Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/cdf20de9a96e3002eb5ba97a68fc6fb2b51ecf63
...
[Benchmark Workflow](https://github.com/axiom-crypto/openvm-reth-benchmark/actions/runs/16379983665)
