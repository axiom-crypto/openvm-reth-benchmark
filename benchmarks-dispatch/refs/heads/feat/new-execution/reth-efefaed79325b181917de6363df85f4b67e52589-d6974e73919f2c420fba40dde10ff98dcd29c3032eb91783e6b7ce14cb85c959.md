...
| `insns               ` |  158,405,667 |  158,405,667 |  158,405,667 |  158,405,667 |
| `execute_e1_time_ms  ` |  974 |  974 |  974 |  974 |
| `execute_e1_insn_mi/s` |  162.50 | -          |  162.50 |  162.50 |
| `execute_metered_time_ms` |  1,599 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  99.02 | -          |  99.02 |  99.02 |
...
| --- | --- | --- |
| 21000000 | 1,678 | 1,055 | 

| group | block_number | insns | execute_metered_time_ms | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insn_mi/s |
| --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_21000000 | 21000000 | 158,405,667 | 1,599 | 99.02 | 974 | 162.50 | 

</details>


Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/efefaed79325b181917de6363df85f4b67e52589
