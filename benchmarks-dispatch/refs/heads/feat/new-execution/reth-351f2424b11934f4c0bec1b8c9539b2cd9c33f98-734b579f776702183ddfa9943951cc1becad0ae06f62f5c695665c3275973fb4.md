...
| `insns               ` |  158,385,012 |  158,385,012 |  158,385,012 |  158,385,012 |
| `execute_e1_time_ms  ` |  967 |  967 |  967 |  967 |
| `execute_e1_insn_mi/s` |  163.76 | -          |  163.76 |  163.76 |
| `execute_metered_time_ms` |  1,523 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  103.94 | -          |  103.94 |  103.94 |
...
| --- | --- | --- |
| 21000000 | 1,599 | 1,043 | 

| group | block_number | insns | execute_metered_time_ms | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insn_mi/s |
| --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_21000000 | 21000000 | 158,385,012 | 1,523 | 103.94 | 967 | 163.76 | 

</details>


Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/351f2424b11934f4c0bec1b8c9539b2cd9c33f98
