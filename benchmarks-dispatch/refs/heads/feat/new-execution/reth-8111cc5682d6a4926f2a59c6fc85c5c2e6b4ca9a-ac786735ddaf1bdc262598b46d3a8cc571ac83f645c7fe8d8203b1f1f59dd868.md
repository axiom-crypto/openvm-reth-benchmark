...
| `execute_e1_time_ms  ` |  2,785 |  2,785 |  2,785 |  2,785 |
| `execute_e1_insn_mi/s` |  56.87 | -          |  56.87 |  56.87 |
| `execute_metered_time_ms` |  3,681 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  43.02 | -          |  43.02 |  43.02 |
...
| --- | --- | --- |
| 21000000 | 4,085 | 3,094 | 

| group | block_number | insns | execute_metered_time_ms | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insn_mi/s |
| --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_21000000 | 21000000 | 158,410,751 | 3,681 | 43.02 | 2,785 | 56.87 | 

</details>


Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/8111cc5682d6a4926f2a59c6fc85c5c2e6b4ca9a
...
[Benchmark Workflow](https://github.com/axiom-crypto/openvm-reth-benchmark/actions/runs/16379899162)
