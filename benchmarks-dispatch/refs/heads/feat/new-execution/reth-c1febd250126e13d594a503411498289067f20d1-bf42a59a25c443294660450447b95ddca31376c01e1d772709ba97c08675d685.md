...
| `execute_e1_time_ms  ` |  2,734 |  2,734 |  2,734 |  2,734 |
| `execute_e1_insn_mi/s` |  57.92 | -          |  57.92 |  57.92 |
| `execute_metered_time_ms` |  3,741 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  42.33 | -          |  42.33 |  42.33 |
...
| --- | --- | --- |
| 21000000 | 3,927 | 2,899 | 

| group | block_number | insns | execute_metered_time_ms | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insn_mi/s |
| --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_21000000 | 21000000 | 158,381,356 | 3,741 | 42.33 | 2,734 | 57.92 | 

</details>


Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/c1febd250126e13d594a503411498289067f20d1
