...
| `insns               ` |  158,433,945 |  158,433,945 |  158,433,945 |  158,433,945 |
| `execute_e1_time_ms  ` |  989 |  989 |  989 |  989 |
| `execute_e1_insn_mi/s` |  160.14 | -          |  160.14 |  160.14 |
| `execute_metered_time_ms` |  1,670 | -          | -          | -          |
...
| --- | --- | --- |
| 21000000 | 1,748 | 1,068 | 

| group | block_number | insns | execute_metered_time_ms | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insn_mi/s |
| --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_21000000 | 21000000 | 158,433,945 | 1,670 | 94.83 | 989 | 160.14 | 

</details>


Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/49089f9ecd8220e6635f4c0ec3cd9ed8e78304dd
