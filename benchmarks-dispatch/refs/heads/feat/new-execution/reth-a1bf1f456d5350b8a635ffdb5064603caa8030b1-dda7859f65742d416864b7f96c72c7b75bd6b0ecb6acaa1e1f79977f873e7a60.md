...
| `execute_e1_time_ms  ` |  1,429 |  1,429 |  1,429 |  1,429 |
| `execute_e1_insn_mi/s` |  110.82 | -          |  110.82 |  110.82 |
| `execute_metered_time_ms` |  2,385 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  66.40 | -          |  66.40 |  66.40 |
...
| --- | --- | --- |
| 21000000 | 2,762 | 1,730 | 

| group | block_number | insns | execute_metered_time_ms | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insn_mi/s |
| --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_21000000 | 21000000 | 158,409,516 | 2,385 | 66.40 | 1,429 | 110.82 | 

</details>


Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/a1bf1f456d5350b8a635ffdb5064603caa8030b1
...
[Benchmark Workflow](https://github.com/axiom-crypto/openvm-reth-benchmark/actions/runs/16305437465)
