...
| `insns               ` |  158,432,517 |  158,432,517 |  158,432,517 |  158,432,517 |
| `execute_e1_time_ms  ` |  982 |  982 |  982 |  982 |
| `execute_e1_insn_mi/s` |  161.29 | -          |  161.29 |  161.29 |
| `execute_metered_time_ms` |  1,782 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  88.88 | -          |  88.88 |  88.88 |
...
| --- | --- | --- |
| 21000000 | 1,859 | 1,061 | 

| group | block_number | insns | execute_metered_time_ms | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insn_mi/s |
| --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_21000000 | 21000000 | 158,432,517 | 1,782 | 88.88 | 982 | 161.29 | 

</details>


Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/fd89b7ec94abe1f6a8fb062686e8173353c61d5f
