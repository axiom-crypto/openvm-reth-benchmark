...
| `insns               ` |  158,414,253 |  158,414,253 |  158,414,253 |  158,414,253 |
| `execute_e1_time_ms  ` |  927 |  927 |  927 |  927 |
| `execute_e1_insn_mi/s` |  170.73 | -          |  170.73 |  170.73 |
| `execute_metered_time_ms` |  1,491 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  106.18 | -          |  106.18 |  106.18 |
...
| --- | --- | --- |
| 21000000 | 1,524 | 1,036 | 

| group | block_number | insns | execute_metered_time_ms | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insn_mi/s |
| --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_21000000 | 21000000 | 158,414,253 | 1,491 | 106.18 | 927 | 170.73 | 

</details>


Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/05a1816007dbed13c50a19282e5674b995332aa3
