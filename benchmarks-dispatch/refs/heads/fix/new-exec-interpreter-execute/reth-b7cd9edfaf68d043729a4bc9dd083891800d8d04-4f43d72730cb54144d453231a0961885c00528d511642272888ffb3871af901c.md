...
| `insns               ` |  158,432,901 |  158,432,901 |  158,432,901 |  158,432,901 |
| `execute_e1_time_ms  ` |  907 |  907 |  907 |  907 |
| `execute_e1_insn_mi/s` |  174.52 | -          |  174.52 |  174.52 |
| `execute_metered_time_ms` |  1,497 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  105.82 | -          |  105.82 |  105.82 |
...
| --- | --- | --- |
| 21000000 | 1,531 | 1,009 | 

| group | block_number | insns | execute_metered_time_ms | execute_metered_insn_mi/s | execute_e1_time_ms | execute_e1_insn_mi/s |
| --- | --- | --- | --- | --- | --- | --- |
| reth.execute_metered.block_21000000 | 21000000 | 158,432,901 | 1,497 | 105.82 | 907 | 174.52 | 

</details>


Commit: https://github.com/axiom-crypto/openvm-reth-benchmark/commit/b7cd9edfaf68d043729a4bc9dd083891800d8d04
...
[Benchmark Workflow](https://github.com/axiom-crypto/openvm-reth-benchmark/actions/runs/16735535485)
