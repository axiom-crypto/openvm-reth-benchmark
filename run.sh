...
PARAMS_DIR="params"
OUTPUT_PATH="metrics.json" samply record --no-open --no-compress -- ./target/$PROFILE/openvm-reth-benchmark --kzg-params-dir $PARAMS_DIR --$MODE --block-number $BLOCK_NUMBER --rpc-url $RPC_1 --cache-dir rpc-cache