...
export JEMALLOC_SYS_WITH_MALLOC_CONF="retain:true,background_thread:true,metadata_thp:always,thp:always,percpu_arena:percpu,dirty_decay_ms:-1,muzzy_decay_ms:-1,abort_conf:true"
