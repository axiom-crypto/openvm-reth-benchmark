...
VMM_PAGE_SIZE=$((8<<20))
VMM_PAGES=$((12 * $MAX_SEGMENT_LENGTH/ $VMM_PAGE_SIZE))
...
RUST_LOG="info,p3_=warn" OUTPUT_PATH="metrics.json" VMM_PAGES=$VMM_PAGES VMM_PAGE_SIZE=$VMM_PAGE_SIZE ./target/$TARGET_DIR/$BIN_NAME \
