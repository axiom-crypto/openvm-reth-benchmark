...
CARGO_PROFILE_PROFILING_DEBUG_ASSERTIONS=true RUST_BACKTRACE=full RUST_LOG="info,p3_=warn" OUTPUT_PATH="metrics.json" VPMM_PAGES=$VPMM_PAGES VPMM_PAGE_SIZE=$VPMM_PAGE_SIZE ./target/$TARGET_DIR/$BIN_NAME \
